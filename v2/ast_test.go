...
func ExampleAbstractDeclaratorOpt_case0() {
	fmt.Println(exampleAST(185, "\U00100000 ( _Atomic )") == (*AbstractDeclaratorOpt)(nil))
	// Output:
	// true
}
...
func ExampleBlockItem_decl() {
	fmt.Println(exampleAST(226, "\U00100001 a { _Atomic ; !"))
	// Output:
	// &cc.BlockItem{
...
func ExampleBlockItemListOpt_case0() {
	fmt.Println(exampleAST(224, "\U00100001 a { }") == (*BlockItemListOpt)(nil))
	// Output:
	// false
}
...
func ExampleDeclarationList_case0() {
	fmt.Println(exampleAST(250, "\U00100001 a _Atomic ; {"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · Scope: &cc.Scope{
...
func ExampleDeclarationList_case1() {
	fmt.Println(exampleAST(251, "\U00100001 a _Atomic ; _Atomic ; {"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · Scope: &cc.Scope{
...
func ExampleDeclarationListOpt_case0() {
	fmt.Println(exampleAST(252, "\U00100001 a {") == (*DeclarationListOpt)(nil))
	// Output:
	// true
}
...
func ExampleDeclaratorOpt_case0() {
	fmt.Println(exampleAST(148, "\U00100001 struct { _Atomic :") == (*DeclaratorOpt)(nil))
	// Output:
	// true
}

func ExampleDeclaratorOpt_case1() {
	fmt.Println(exampleAST(149, "\U00100001 struct { _Atomic a :"))
	// Output:
	// &cc.DeclaratorOpt{
	// · Declarator: &cc.Declarator{
	// · · Linkage: LinkageNone,
...
func ExampleDesignator_field() {
	fmt.Println(exampleAST(207, "\U00100000 ( _Atomic ) { . a ."))
	// Output:
	// &cc.Designator{
	// · Token: '.',
	// · Token2: IDENTIFIER "a",
...
func ExampleDesignator_index() {
	fmt.Println(exampleAST(208, "\U00100000 ( _Atomic ) { [ 'a' ] ."))
	// Output:
	// &cc.Designator{
	// · Case: 1,
	// · ConstExpr: &cc.ConstExpr{
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(206, "\U00100000 ( _Atomic ) { . a . b ."))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Token: '.',
...
func ExampleDirectAbstractDeclarator_dArrSize() {
	fmt.Println(exampleAST(190, "\U00100000 ( _Atomic [ static 'a' ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 3,
	// · Expr: &cc.Expr{
...
func ExampleDirectAbstractDeclarator_dArrSize2() {
	fmt.Println(exampleAST(193, "\U00100000 ( _Atomic [ _Atomic static 'a' ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 6,
	// · Expr: &cc.Expr{
...
func ExampleDirectAbstractDeclarator_dArr2() {
	fmt.Println(exampleAST(194, "\U00100000 ( _Atomic [ _Atomic ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 7,
	// · Token: '[',
...
func ExampleDirectAbstractDeclaratorOpt_case0() {
	fmt.Println(exampleAST(195, "\U00100000 ( _Atomic [") == (*DirectAbstractDeclaratorOpt)(nil))
	// Output:
	// true
}

func ExampleDirectAbstractDeclaratorOpt_case1() {
	fmt.Println(exampleAST(196, "\U00100000 ( _Atomic ( ) ["))
	// Output:
...
func ExampleDirectDeclarator_paramList() {
	fmt.Println(exampleAST(154, "\U00100001 a ( _Atomic ) ("))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arraySize() {
	fmt.Println(exampleAST(155, "\U00100001 a [ static 'b' ] ("))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arraySize2() {
	fmt.Println(exampleAST(156, "\U00100001 a [ _Atomic static 'b' ] ("))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arrayVar() {
	fmt.Println(exampleAST(157, "\U00100001 a [ * ] ("))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleExternalDeclaration_func() {
	fmt.Println(exampleAST(243, "\U00100001 a { }"))
	// Output:
	// &cc.ExternalDeclaration{
	// · Case: 1,
...
func ExampleExternalDeclarationList_case0() {
	fmt.Println(exampleAST(240, "\U00100001 _Atomic ;"))
	// Output:
...
func ExampleExternalDeclarationList_case1() {
	fmt.Println(exampleAST(241, "\U00100001 _Atomic ; _Atomic ;"))
	// Output:
	// &cc.ExternalDeclarationList{
	// · ExternalDeclaration: &cc.ExternalDeclaration{
	// · · Declaration: &cc.Declaration{
...
func ExampleFunctionDefinition_spec() {
	fmt.Println(exampleAST(245, "\U00100001 _Atomic a { }"))
	// Output:
...
func ExampleFunctionDefinition_int() {
	fmt.Println(exampleAST(247, "\U00100001 a { }"))
	// Output:
	// &cc.FunctionDefinition{
	// · Case: 1,
	// · Declarator: &cc.Declarator{
...
func ExampleIdentifierList_case0() {
	fmt.Println(exampleAST(176, "\U00100001 a ( b )"))
	// Output:
	// &cc.IdentifierList{
	// · Token: IDENTIFIER "b",
	// }
...
func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(177, "\U00100001 a ( b , c )"))
	// Output:
	// &cc.IdentifierList{
...
func ExampleIdentifierListOpt_case0() {
	fmt.Println(exampleAST(178, "\U00100001 a ( )") == (*IdentifierListOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierListOpt_case1() {
	fmt.Println(exampleAST(179, "\U00100001 a ( b )"))
	// Output:
...
func ExampleIdentifierOpt_case0() {
	fmt.Println(exampleAST(180, "\U00100001 struct {") == (*IdentifierOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierOpt_case1() {
	fmt.Println(exampleAST(181, "\U00100001 enum a {"))
	// Output:
	// &cc.IdentifierOpt{
	// · Token: IDENTIFIER "a",
	// }
...
func ExampleInitializer_compLit() {
	fmt.Println(exampleAST(197, "\U00100001 _Atomic a = { } ,"))
	// Output:
	// &cc.Initializer{
	// · Token: '{',
	// · Token2: '}',
...
func ExampleInitializer_expr() {
	fmt.Println(exampleAST(198, "\U00100001 _Atomic a = 'b' ,"))
	// Output:
	// &cc.Initializer{
	// · Case: 1,
	// · Expr: &cc.Expr{
...
func ExampleInitializerList_case0() {
	fmt.Println(exampleAST(199, "\U00100000 ( _Atomic ) { ,") == (*InitializerList)(nil))
	// Output:
	// true
}
...
func ExampleInitializerList_case2() {
	fmt.Println(exampleAST(201, "\U00100000 ( _Atomic ) { . a = 'b' ,"))
	// Output:
	// &cc.InitializerList{
	// · Case: 2,
...
func ExampleIterationStmt_do() {
	fmt.Println(exampleAST(232, "\U00100001 a { do ; while ( 'b' ) ; !"))
	// Output:
	// &cc.IterationStmt{
	// · ExprList: &cc.ExprList{
	// · · Expr: &cc.Expr{
...
func ExampleIterationStmt_forDecl() {
	fmt.Println(exampleAST(233, "\U00100001 a { for ( _Atomic ; ; ) ; !"))
	// Output:
	// &cc.IterationStmt{
	// · Case: 1,
	// · Declaration: &cc.Declaration{
...
func ExampleIterationStmt_for() {
	fmt.Println(exampleAST(234, "\U00100001 a { for ( ; ; ) ; !"))
	// Output:
	// &cc.IterationStmt{
	// · Case: 2,
	// · Stmt: &cc.Stmt{
...
func ExampleIterationStmt_while() {
	fmt.Println(exampleAST(235, "\U00100001 a { while ( 'b' ) ; !"))
	// Output:
	// &cc.IterationStmt{
	// · Case: 3,
	// · ExprList: &cc.ExprList{
...
func ExampleJumpStmt_break() {
	fmt.Println(exampleAST(236, "\U00100001 a { break ; !"))
	// Output:
	// &cc.JumpStmt{
	// · Token: BREAK "break",
	// · Token2: ';',
...
func ExampleJumpStmt_continue() {
	fmt.Println(exampleAST(237, "\U00100001 a { continue ; !"))
	// Output:
	// &cc.JumpStmt{
	// · Case: 1,
...
func ExampleJumpStmt_goto() {
	fmt.Println(exampleAST(238, "\U00100001 a { goto b ; !"))
	// Output:
	// &cc.JumpStmt{
	// · Case: 2,
	// · Token: GOTO "goto",
...
func ExampleJumpStmt_return() {
	fmt.Println(exampleAST(239, "\U00100001 a { return ; !"))
	// Output:
	// &cc.JumpStmt{
	// · Case: 3,
	// · Token: RETURN "return",
...
func ExampleLabeledStmt_switchCase() {
	fmt.Println(exampleAST(215, "\U00100001 a { case 'b' : ; !"))
	// Output:
	// &cc.LabeledStmt{
	// · ConstExpr: &cc.ConstExpr{
	// · · Expr: &cc.Expr{
...
func ExampleLabeledStmt_default() {
	fmt.Println(exampleAST(216, "\U00100001 a { default : ; !"))
	// Output:
	// &cc.LabeledStmt{
	// · Case: 1,
	// · Stmt: &cc.Stmt{
...
func ExampleLabeledStmt_label() {
	fmt.Println(exampleAST(217, "\U00100001 a { b : ; !"))
	// Output:
	// &cc.LabeledStmt{
	// · Case: 2,
	// · Stmt: &cc.Stmt{
...
func ExampleLabeledStmt_label2() {
	fmt.Println(exampleAST(218, "\U00100001 a { typedef name : ; !"))
	// Output:
	// TODO: example218.c:1:19: unexpected ':', expected one of [',', ';', '=']
}
...
func ExampleParameterDeclaration_declarator() {
	fmt.Println(exampleAST(175, "\U00100001 a ( _Atomic b )"))
	// Output:
	// &cc.ParameterDeclaration{
	// · Case: 1,
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleParameterList_case0() {
	fmt.Println(exampleAST(172, "\U00100001 a ( _Atomic )"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(173, "\U00100001 a ( _Atomic , _Atomic )"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleParameterTypeListOpt_case0() {
	fmt.Println(exampleAST(170, "\U00100000 ( _Atomic ( )") == (*ParameterTypeListOpt)(nil))
	// Output:
	// true
}

func ExampleParameterTypeListOpt_case1() {
	fmt.Println(exampleAST(171, "\U00100000 ( _Atomic ( _Atomic )"))
	// Output:
...
func ExamplePointer_base() {
	fmt.Println(exampleAST(160, "\U00100001 * ("))
	// Output:
	// &cc.Pointer{
	// · Token: '*',
	// }
...
func ExamplePointerOpt_case0() {
	fmt.Println(exampleAST(162, "\U00100001 (") == (*PointerOpt)(nil))
	// Output:
	// true
}
...
func ExampleSelectionStmt_ifElse() {
	fmt.Println(exampleAST(229, "\U00100001 a { if ( 'b' ) ; else ; !"))
	// Output:
	// &cc.SelectionStmt{
	// · ExprList: &cc.ExprList{
	// · · Expr: &cc.Expr{
...
func ExampleSelectionStmt_if() {
	fmt.Println(exampleAST(230, "\U00100001 a { if ( 'b' ) ; !"))
	// Output:
	// &cc.SelectionStmt{
	// · Case: 1,
	// · ExprList: &cc.ExprList{
...
func ExampleSelectionStmt_switch() {
	fmt.Println(exampleAST(231, "\U00100001 a { switch ( 'b' ) ; !"))
	// Output:
	// &cc.SelectionStmt{
	// · Case: 2,
	// · ExprList: &cc.ExprList{
...
func ExampleStmt_iter() {
	fmt.Println(exampleAST(211, "\U00100001 a { while ( 'b' ) ; !"))
	// Output:
	// &cc.Stmt{
	// · Case: 2,
...
func ExampleStmt_jump() {
	fmt.Println(exampleAST(212, "\U00100001 a { break ; !"))
	// Output:
	// &cc.Stmt{
	// · Case: 3,
...
func ExampleStmt_labeled() {
	fmt.Println(exampleAST(213, "\U00100001 a { default : ; !"))
	// Output:
	// &cc.Stmt{
	// · Case: 4,
...
func ExampleStmt_select() {
	fmt.Println(exampleAST(214, "\U00100001 a { if ( 'b' ) ; !"))
	// Output:
	// &cc.Stmt{
	// · Case: 5,
...
func ExampleTypeQualifierList_case0() {
	fmt.Println(exampleAST(164, "\U00100001 * _Atomic !"))
	// Output:
...
func ExampleTypeQualifierList_case1() {
	fmt.Println(exampleAST(165, "\U00100001 * _Atomic _Atomic !"))
	// Output:
	// &cc.TypeQualifierList{
	// · TypeQualifier: &cc.TypeQualifier{
	// · · Case: 3,
...
func ExampleTypeQualifierListOpt_case0() {
	fmt.Println(exampleAST(166, "\U00100001 * (") == (*TypeQualifierListOpt)(nil))
	// Output:
	// true
}

func ExampleTypeQualifierListOpt_case1() {
	fmt.Println(exampleAST(167, "\U00100001 * _Atomic !"))
	// Output:
