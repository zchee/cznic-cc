...
func ExampleAbstractDeclarator_case1() {
	...
	// · · Token2: example175.c:1:16: ')',
	// · },
	// }
}

func ExampleAbstractDeclaratorOpt() {
	fmt.Println(exampleAST(176, "\U00100001 ( _Bool )") == (*AbstractDeclaratorOpt)(nil))
	// Output:
	// true
}
...
func ExampleBlockItem() {
	fmt.Println(exampleAST(216, "\U00100002 auto a { auto ; !"))
	// Output:
	// &cc.BlockItem{
	...
	// · · · · Case: 3,
	// · · · · Token: example216.c:1:15: AUTO "auto",
	// · · · },
	// · · },
...
func ExampleBlockItemListOpt() {
	fmt.Println(exampleAST(214, "\U00100002 auto a { }") == (*BlockItemListOpt)(nil))
	// Output:
	// true
}
...
func ExampleCommaOpt() {
	fmt.Println(exampleAST(125, "\U00100002 enum { a }") == (*CommaOpt)(nil))
	// Output:
	// true
}

func ExampleCommaOpt_case1() {
	fmt.Println(exampleAST(126, "\U00100001 ( _Bool ) { 'a' , }"))
	// Output:
	// &cc.CommaOpt{
	// · Token: example126.c:1:22: ',',
	// }
}
...
func ExampleConstantExpression() {
	...
	// · · Value: 97,
	// · · Case: 1,
	// · · Token: example74.c:1:6: CHARCONST "'a'",
	// · },
	// }
}
...
func ExampleControlLine() {
	...
	// Output:
	// &cc.ControlLine{
	// · Token: example262.c:2:2: PPDEFINE,
	// · Token2: example262.c:2:9: IDENTIFIER "a",
	// }
}
...
func ExampleControlLine_case01() {
	...
	// · Token2: example263.c:2:9: IDENTIFIER_LPAREN "a(",
	// · Token3: example263.c:2:12: DDD,
	// · Token4: example263.c:2:16: ')',
	// }
}
...
func ExampleControlLine_case02() {
	...
	// · · Token: example264.c:2:12: IDENTIFIER "b",
	// · },
	// · Token: example264.c:2:2: PPDEFINE,
	// · Token2: example264.c:2:9: IDENTIFIER_LPAREN "a(",
	// · Token3: example264.c:2:14: ',',
	// · Token4: example264.c:2:16: DDD,
	// · Token5: example264.c:2:20: ')',
	// }
}
...
func ExampleControlLine_case04() {
	...
	// &cc.ControlLine{
	// · Case: 4,
	// · Token: example266.c:2:2: PPERROR,
	// }
}
...
func ExampleControlLine_case05() {
	...
	// &cc.ControlLine{
	// · Case: 5,
	// · Token: example267.c:2:2: PPHASH_NL,
	// }
}
...
func ExampleControlLine_case06() {
	...
	// · · 0: example268.c:2:10: IDENTIFIER "other_a",
	// · },
	// · Token: example268.c:2:2: PPINCLUDE,
	// · Token2: example268.c:2:18: '\n',
	// }
}
...
func ExampleControlLine_case07() {
	...
	// · Case: 7,
	// · PPTokenList: []xc.Token{ // len 1
	// · · 0: example269.c:2:7: IDENTIFIER "other_a",
	// · },
	// · Token: example269.c:2:2: PPLINE,
	// · Token2: example269.c:2:15: '\n',
	// }
}
...
func ExampleControlLine_case08() {
	...
	// &cc.ControlLine{
	// · Case: 8,
	// · Token: example270.c:2:2: PPPRAGMA,
	// }
}
...
func ExampleControlLine_case09() {
	...
	// &cc.ControlLine{
	// · Case: 9,
	// · Token: example271.c:2:2: PPUNDEF,
	// · Token2: example271.c:2:8: IDENTIFIER "a",
	// · Token3: example271.c:2:10: '\n',
	// }
}
...
func ExampleControlLine_case10() {
	...
	// &cc.ControlLine{
	// · Case: 10,
	// · Token: example272.c:2:2: PPDEFINE,
	// · Token2: example272.c:2:9: IDENTIFIER_LPAREN "a(",
	// · Token3: example272.c:2:12: IDENTIFIER "b",
	// · Token4: example272.c:2:14: DDD,
	// · Token5: example272.c:2:18: ')',
	// }
}
...
func ExampleControlLine_case11() {
	...
	// · Case: 11,
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example273.c:2:12: IDENTIFIER "b",
	// · },
	// · Token: example273.c:2:2: PPDEFINE,
	// · Token2: example273.c:2:9: IDENTIFIER_LPAREN "a(",
	// · Token3: example273.c:2:14: ',',
	// · Token4: example273.c:2:16: IDENTIFIER "c",
	// · Token5: example273.c:2:18: DDD,
	// · Token6: example273.c:2:22: ')',
	// }
}
...
func ExampleControlLine_case13() {
	...
	// · · 0: example275.c:2:11: '(',
	// · · 1: example275.c:2:12: IDENTIFIER "bar",
	// · · 2: example275.c:2:15: ')',
	// · },
	// · Token: example275.c:2:2: PPUNDEF,
	// · Token2: example275.c:2:8: IDENTIFIER "foo",
	// · Token3: example275.c:2:16: '\n',
	// }
}

func ExampleDeclaration() {
	fmt.Println(exampleAST(75, "\U00100002 auto ;"))
	// Output:
	// &cc.Declaration{
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	// · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · Case: 3,
	// · · · Token: example75.c:1:6: AUTO "auto",
	// · · },
	// · },
	// · Token: example75.c:1:11: ';',
	// }
}

func ExampleDeclarationList() {
	fmt.Println(exampleAST(236, "\U00100002 auto a auto ; {"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	// · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · Case: 3,
	// · · · · Token: example236.c:1:13: AUTO "auto",
	// · · · },
	// · · },
...
func ExampleDeclarationList_case1() {
	fmt.Println(exampleAST(237, "\U00100002 auto a auto ; auto ; {"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	...
	// · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · Case: 3,
	// · · · · · Token: example237.c:1:20: AUTO "auto",
	// · · · · },
	// · · · },
	// · · · Token: example237.c:1:25: ';',
	// · · },
	// · },
	// }
}
...
func ExampleDeclarationListOpt() {
	fmt.Println(exampleAST(238, "\U00100002 auto a {") == (*DeclarationListOpt)(nil))
	// Output:
	// true
}

func ExampleDeclarationListOpt_case1() {
	fmt.Println(exampleAST(239, "\U00100002 auto a auto ; {"))
	// Output:
	...
	// · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · Case: 3,
	// · · · · · Token: example239.c:1:13: AUTO "auto",
	// · · · · },
	// · · · },
	// · · · Token: example239.c:1:18: ';',
	// · · },
	// · },
	// }
}
...
func ExampleDeclarationSpecifiers_case1() {
	fmt.Println(exampleAST(77, "\U00100002 _Bool ("))
	// Output:
	// &cc.DeclarationSpecifiers{
	// · Case: 1,
	// · TypeSpecifier: &cc.TypeSpecifier{
	// · · Case: 9,
	// · · Token: example77.c:1:6: BOOL "_Bool",
	// · },
	// }
}

func ExampleDeclarationSpecifiers_case2() {
	fmt.Println(exampleAST(78, "\U00100002 const ("))
	// Output:
	// &cc.DeclarationSpecifiers{
	// · Case: 2,
	// · TypeQualifier: &cc.TypeQualifier{
	// · · Token: example78.c:1:6: CONST "const",
	// · },
	// }
}

func ExampleDeclarationSpecifiers_case3() {
	fmt.Println(exampleAST(79, "\U00100002 inline ("))
	// Output:
	// &cc.DeclarationSpecifiers{
	// · Case: 3,
	// · FunctionSpecifier: &cc.FunctionSpecifier{
	// · · Token: example79.c:1:6: INLINE "inline",
	// · },
	// }
}

func ExampleDeclarationSpecifiersOpt() {
	fmt.Println(exampleAST(80, "\U00100002 auto (") == (*DeclarationSpecifiersOpt)(nil))
	// Output:
	// true
}

func ExampleDeclarationSpecifiersOpt_case1() {
	fmt.Println(exampleAST(81, "\U00100002 inline auto ("))
	// Output:
	// &cc.DeclarationSpecifiersOpt{
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	// · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · Case: 3,
	// · · · Token: example81.c:1:13: AUTO "auto",
	// · · },
	// · },
	// }
}
...
func ExampleDeclarator() {
	fmt.Println(exampleAST(138, "\U00100002 auto a )"))
	// Output:
	// &cc.Declarator{
	// · Linkage: None,
	// · DirectDeclarator: &cc.DirectDeclarator{
	// · · Token: example138.c:1:11: IDENTIFIER "a",
	// · },
	// }
}

func ExampleDeclaratorOpt() {
	fmt.Println(exampleAST(139, "\U00100002 struct { _Bool :") == (*DeclaratorOpt)(nil))
	// Output:
	// true
}
...
func ExampleDesignation() {
	fmt.Println(exampleAST(194, "\U00100001 ( _Bool ) { . a = !"))
	// Output:
	// &cc.Designation{
	// · DesignatorList: &cc.DesignatorList{
	// · · Designator: &cc.Designator{
	// · · · Case: 1,
	// · · · Token: example194.c:1:18: '.',
	// · · · Token2: example194.c:1:20: IDENTIFIER "a",
	// · · },
	// · },
	// · Token: example194.c:1:22: '=',
	// }
}

func ExampleDesignationOpt() {
	fmt.Println(exampleAST(195, "\U00100001 ( _Bool ) { !") == (*DesignationOpt)(nil))
	// Output:
	// true
}
...
func ExampleDesignationOpt_case1() {
	...
	// · · · Designator: &cc.Designator{
	// · · · · Case: 1,
	// · · · · Token: example196.c:1:18: '.',
	// · · · · Token2: example196.c:1:20: IDENTIFIER "a",
	// · · · },
	// · · },
	// · · Token: example196.c:1:22: '=',
	// · },
	// }
}
...
func ExampleDesignator() {
	...
	// · · · Value: 97,
	// · · · Case: 1,
	// · · · Token: example199.c:1:20: CHARCONST "'a'",
	// · · },
	// · },
	// · Token: example199.c:1:18: '[',
	// · Token2: example199.c:1:24: ']',
	// }
}
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(198, "\U00100001 ( _Bool ) { . a . b ."))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Case: 1,
	...
	// · · · Token2: example198.c:1:24: IDENTIFIER "b",
	// · · },
	// · },
	// }
}
...
func ExampleDirectAbstractDeclarator() {
	...
	// · AbstractDeclarator: &cc.AbstractDeclarator{
	// · · Pointer: &cc.Pointer{
	// · · · Token: example178.c:1:16: '*',
	// · · },
	// · },
	// · Token: example178.c:1:14: '(',
	// · Token2: example178.c:1:18: ')',
	// }
}
...
func ExampleDirectAbstractDeclarator_case2() {
	fmt.Println(exampleAST(180, "\U00100001 ( _Bool [ const ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 2,
	// · Token: example180.c:1:14: '[',
	// · Token2: example180.c:1:22: ']',
	// · TypeQualifierList: &cc.TypeQualifierList{
	// · · TypeQualifier: &cc.TypeQualifier{
	// · · · Token: example180.c:1:16: CONST "const",
	// · · },
	// · },
	// }
}
...
func ExampleDirectAbstractDeclarator_case3() {
	fmt.Println(exampleAST(181, "\U00100001 ( _Bool [ static 'a' ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 3,
	// · Expression: &cc.Expression{
	...
	// · · Value: 97,
	// · · Case: 1,
	// · · Token: example181.c:1:23: CHARCONST "'a'",
	// · },
	// · Token: example181.c:1:14: '[',
	// · Token2: example181.c:1:16: STATIC "static",
	// · Token3: example181.c:1:27: ']',
	// }
}

func ExampleDirectAbstractDeclarator_case4() {
	fmt.Println(exampleAST(182, "\U00100001 ( _Bool [ const static 'a' ] ("))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: 4,
	// · Expression: &cc.Expression{
	...
	// · · Value: 97,
	// · · Case: 1,
	// · · Token: example182.c:1:29: CHARCONST "'a'",
	// · },
	// · Token: example182.c:1:14: '[',
	// · Token2: example182.c:1:22: STATIC "static",
	// · Token3: example182.c:1:33: ']',
	// · TypeQualifierList: &cc.TypeQualifierList{
	// · · TypeQualifier: &cc.TypeQualifier{
	// · · · Token: example182.c:1:16: CONST "const",
	// · · },
	// · },
	// }
}
...
func ExampleDirectAbstractDeclarator_case7() {
	...
	// · },
	// · Token: example187.c:1:18: '(',
	// · Token2: example187.c:1:20: ')',
	// }
}

func ExampleDirectAbstractDeclaratorOpt() {
	fmt.Println(exampleAST(188, "\U00100001 ( _Bool [") == (*DirectAbstractDeclaratorOpt)(nil))
	// Output:
	// true
}
...
func ExampleDirectDeclarator() {
	fmt.Println(exampleAST(141, "\U00100002 auto a ("))
	// Output:
	// &cc.DirectDeclarator{
	// · Token: example141.c:1:11: IDENTIFIER "a",
	// }
}
...
func ExampleDirectDeclarator_case1() {
	...
	// · · Linkage: None,
	// · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · Token: example142.c:1:13: IDENTIFIER "a",
	// · · },
	// · },
	// · Token: example142.c:1:11: '(',
	// · Token2: example142.c:1:15: ')',
	// }
}
...
func ExampleDirectDeclarator_case2() {
	...
	// · },
	// · Token: example143.c:1:13: '[',
	// · Token2: example143.c:1:15: ']',
	// }
}

func ExampleDirectDeclarator_case3() {
	fmt.Println(exampleAST(144, "\U00100002 auto a [ static 'b' ] ("))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: 3,
	// · DirectDeclarator: &cc.DirectDeclarator{
	...
	// · · Value: 98,
	// · · Case: 1,
	// · · Token: example144.c:1:22: CHARCONST "'b'",
	// · },
	// · Token: example144.c:1:13: '[',
	// · Token2: example144.c:1:15: STATIC "static",
	// · Token3: example144.c:1:26: ']',
	// }
}

func ExampleDirectDeclarator_case4() {
	fmt.Println(exampleAST(145, "\U00100002 auto a [ const static 'b' ] ("))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: 4,
	// · DirectDeclarator: &cc.DirectDeclarator{
	...
	// · · Value: 98,
	// · · Case: 1,
	// · · Token: example145.c:1:28: CHARCONST "'b'",
	// · },
	// · Token: example145.c:1:13: '[',
	// · Token2: example145.c:1:21: STATIC "static",
	// · Token3: example145.c:1:32: ']',
	// · TypeQualifierList: &cc.TypeQualifierList{
	// · · TypeQualifier: &cc.TypeQualifier{
	// · · · Token: example145.c:1:15: CONST "const",
	// · · },
	// · },
	// }
}
...
func ExampleDirectDeclarator_case5() {
	...
	// · Token3: example146.c:1:17: ']',
	// }
}

func ExampleDirectDeclarator_case6() {
	fmt.Println(exampleAST(148, "\U00100002 auto a ( auto ) ("))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: 6,
	// · DirectDeclarator: &cc.DirectDeclarator{
	...
	// · · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · · Case: 3,
	// · · · · · · Token: example148.c:1:15: AUTO "auto",
	// · · · · · },
	// · · · · },
	// · · · },
	// · · },
...
func ExampleElifGroupList() {
	...
	// · · PPTokenList: []xc.Token{ // len 1
	// · · · 0: example253.c:3:7: IDENTIFIER "other_b",
	// · · },
	// · · Token: example253.c:3:2: PPELIF,
	// · · Token2: example253.c:3:16: '\n',
	// · },
	// }
}
...
func ExampleElifGroupList_case1() {
	...
	// · · ElifGroup: &cc.ElifGroup{
	// · · · PPTokenList: []xc.Token{ // len 1
	// · · · · 0: example254.c:4:7: IDENTIFIER "other_c",
	// · · · },
	// · · · Token: example254.c:4:2: PPELIF,
	// · · · Token2: example254.c:4:16: '\n',
	// · · },
	// · },
	// }
}
...
func ExampleElseGroup() {
	...
	// Output:
	// &cc.ElseGroup{
	// · Token: example258.c:3:2: PPELSE,
	// · Token2: example258.c:3:8: '\n',
	// }
}
...
func ExampleElseGroupOpt_case1() {
	...
	// · · Token: example260.c:3:2: PPELSE,
	// · · Token2: example260.c:3:8: '\n',
	// · },
	// }
}
...
func ExampleEndifLine() {
	...
	// Output:
	// &cc.EndifLine{
	// · Token: example261.c:3:2: PPENDIF,
	// }
}

func ExampleEnumSpecifier() {
	fmt.Println(exampleAST(128, "\U00100002 enum { a } ("))
	// Output:
	// &cc.EnumSpecifier{
	// · EnumeratorList: &cc.EnumeratorList{
	// · · Enumerator: &cc.Enumerator{
	// · · · EnumerationConstant: &cc.EnumerationConstant{
	// · · · · Token: example128.c:1:13: IDENTIFIER "a",
	// · · · },
	// · · },
	// · },
	// · Token: example128.c:1:6: ENUM "enum",
	// · Token2: example128.c:1:11: '{',
	// · Token3: example128.c:1:15: '}',
	// }
}
...
func ExampleEnumSpecifier_case1() {
	...
	// · Token2: example129.c:1:11: IDENTIFIER "a",
	// }
}
...
func ExampleEnumerator_case1() {
	fmt.Println(exampleAST(133, "\U00100002 enum { a = 'b' ,"))
	// Output:
	// &cc.Enumerator{
	// · Case: 1,
	// · ConstantExpression: &cc.ConstantExpression{
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example133.c:1:17: CHARCONST "'b'",
	// · · },
	// · },
	// · EnumerationConstant: &cc.EnumerationConstant{
	// · · Token: example133.c:1:13: IDENTIFIER "a",
	// · },
	// · Token: example133.c:1:15: '=',
	// }
}
...
func ExampleEnumeratorList() {
	...
	// · Enumerator: &cc.Enumerator{
	// · · EnumerationConstant: &cc.EnumerationConstant{
	// · · · Token: example130.c:1:13: IDENTIFIER "a",
	// · · },
	// · },
	// }
}
...
func ExampleEnumeratorList_case1() {
	fmt.Println(exampleAST(131, "\U00100002 enum { a , b ,"))
	// Output:
	// &cc.EnumeratorList{
	// · Enumerator: &cc.Enumerator{
	// · · EnumerationConstant: &cc.EnumerationConstant{
	...
	// · · Enumerator: &cc.Enumerator{
	// · · · EnumerationConstant: &cc.EnumerationConstant{
	// · · · · Token: example131.c:1:17: IDENTIFIER "b",
	// · · · },
	// · · },
	// · · Token: example131.c:1:15: ',',
	// · },
	// }
}
...
func ExampleExternalDeclaration() {
	...
	// · · · Type: auto undefined,
	// · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · Token: example232.c:1:11: IDENTIFIER "a",
	// · · · },
	// · · },
	// · },
	// }
...
func ExampleExternalDeclaration_case1() {
	fmt.Println(exampleAST(233, "\U00100002 auto ;"))
	// Output:
	// &cc.ExternalDeclaration{
	// · Case: 1,
	// · Declaration: &cc.Declaration{
	...
	// · · · },
	// · · },
	// · · Token: example233.c:1:11: ';',
	// · },
	// }
}

func ExampleFunctionDefinition() {
	fmt.Println(exampleAST(235, "\U00100002 auto a { }"))
	// Output:
	// &cc.FunctionDefinition{
	// · CompoundStatement: &cc.CompoundStatement{
	// · · Token: example235.c:1:13: '{',
	// · · Token2: example235.c:1:15: '}',
	// · },
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	// · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · Case: 3,
	...
	// · · Type: auto undefined,
	// · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · Token: example235.c:1:11: IDENTIFIER "a",
	// · · },
	// · },
	// }
}
...
func ExampleFunctionSpecifier() {
	fmt.Println(exampleAST(137, "\U00100002 inline ("))
	// Output:
	// &cc.FunctionSpecifier{
	// · Token: example137.c:1:6: INLINE "inline",
	// }
}
...
func ExampleGroupList_case1() {
	fmt.Println(exampleAST(242, "\U00100000int\nf() {}"))
	// Output:
	// &cc.GroupList{
	// · GroupList: &cc.GroupList{
	// · · Case: 1,
	// · · GroupPart: []xc.Token{ // len 5
	// · · · 0: example242.c:2:1: IDENTIFIER "f",
	// · · · 1: example242.c:2:2: '(',
	// · · · 2: example242.c:2:3: ')',
	// · · · 3: example242.c:2:5: '{',
	// · · · 4: example242.c:2:6: '}',
	...
	// · · 0: example242.c:1:5: IDENTIFIER "int",
	// · },
	// }
}

func ExampleGroupListOpt() {
	fmt.Println(exampleAST(243, "\U00100000 \n#ifndef a  \n#elif") == (*GroupListOpt)(nil))
	// Output:
	// true
}
...
func ExampleGroupListOpt_case1() {
	...
	// · GroupList: &cc.GroupList{
	// · · GroupPart: []xc.Token{ // len 1
	// · · · 0: example244.c:3:1: IDENTIFIER "b",
	// · · },
	// · },
	// }
}
...
func ExampleIdentifierList() {
	fmt.Println(exampleAST(166, "\U00100002 auto a ( b )"))
	// Output:
	// &cc.IdentifierList{
	// · Token: example166.c:1:15: IDENTIFIER "b",
	// }
}

func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(167, "\U00100002 auto a ( b , c )"))
	// Output:
	// &cc.IdentifierList{
	// · IdentifierList: &cc.IdentifierList{
	// · · Case: 1,
	// · · Token: example167.c:1:17: ',',
	// · · Token2: example167.c:1:19: IDENTIFIER "c",
	// · },
...
func ExampleIdentifierListOpt() {
	fmt.Println(exampleAST(168, "\U00100002 auto a ( )") == (*IdentifierListOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierListOpt_case1() {
	fmt.Println(exampleAST(169, "\U00100002 auto a ( b )"))
	// Output:
	// &cc.IdentifierListOpt{
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example169.c:1:15: IDENTIFIER "b",
	// · },
	// }
}

func ExampleIdentifierOpt() {
	fmt.Println(exampleAST(170, "\U00100002 struct {") == (*IdentifierOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierOpt_case1() {
	fmt.Println(exampleAST(171, "\U00100002 enum a {"))
	// Output:
	// &cc.IdentifierOpt{
	// · Token: example171.c:1:11: IDENTIFIER "a",
	// }
}
...
func ExampleIfGroup_case1() {
	...
	// &cc.IfGroup{
	// · Case: 1,
	// · Token: example251.c:2:2: PPIFDEF,
	// · Token2: example251.c:2:8: IDENTIFIER "a",
	// · Token3: example251.c:2:11: '\n',
	// }
}
...
func ExampleIfGroup_case2() {
	...
	// &cc.IfGroup{
	// · Case: 2,
	// · Token: example252.c:2:2: PPIFNDEF,
	// · Token2: example252.c:2:9: IDENTIFIER "a",
	// · Token3: example252.c:2:12: '\n',
	// }
}
...
func ExampleIfSection() {
	...
	// · · Token: example249.c:3:2: PPENDIF,
	// · },
	// · IfGroup: &cc.IfGroup{
	// · · PPTokenList: []xc.Token{ // len 1
	// · · · 0: example249.c:2:5: IDENTIFIER "other_a",
	// · · },
	// · · Token: example249.c:2:2: PPIF,
	// · · Token2: example249.c:2:14: '\n',
	// · },
	// }
}
...
func ExampleInitDeclarator_case1() {
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example88.c:1:15: CHARCONST "'b'",
	// · · },
	// · },
	// · Token: example88.c:1:13: '=',
	// }
}

func ExampleInitDeclaratorList() {
	fmt.Println(exampleAST(82, "\U00100002 auto a ,"))
	// Output:
	...
	// · · · Type: auto undefined,
	// · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · Token: example82.c:1:11: IDENTIFIER "a",
	// · · · },
	// · · },
	// · },
	// }
...
func ExampleInitDeclaratorList_case1() {
	fmt.Println(exampleAST(83, "\U00100002 auto a , b ,"))
	// Output:
	// &cc.InitDeclaratorList{
	// · InitDeclarator: &cc.InitDeclarator{
	// · · Declarator: &cc.Declarator{
	...
	// · · · · Type: auto undefined,
	// · · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · · Token: example83.c:1:15: IDENTIFIER "b",
	// · · · · },
	// · · · },
	// · · },
	// · · Token: example83.c:1:13: ',',
	// · },
	// }
}

func ExampleInitDeclaratorListOpt() {
	fmt.Println(exampleAST(84, "\U00100002 auto ;") == (*InitDeclaratorListOpt)(nil))
	// Output:
	// true
}
...
func ExampleInitializer() {
	...
	// · · Value: 98,
	// · · Case: 1,
	// · · Token: example190.c:1:15: CHARCONST "'b'",
	// · },
	// }
}
...
func ExampleInitializer_case1() {
	...
	// · · · · Value: 98,
	// · · · · Case: 1,
	// · · · · Token: example191.c:1:17: CHARCONST "'b'",
	// · · · },
	// · · },
	// · },
	// · Token: example191.c:1:15: '{',
	// · Token2: example191.c:1:21: '}',
	// }
}

func ExampleInitializerList() {
	fmt.Println(exampleAST(192, "\U00100001 ( _Bool ) { 'a' ,"))
	// Output:
	// &cc.InitializerList{
	// · Initializer: &cc.Initializer{
	// · · Expression: &cc.Expression{
	...
	// · · · Value: 97,
	// · · · Case: 1,
	// · · · Token: example192.c:1:18: CHARCONST "'a'",
	// · · },
	// · },
	// }
}
...
func ExampleInitializerList_case1() {
	fmt.Println(exampleAST(193, "\U00100001 ( _Bool ) { 'a' , 'b' ,"))
	// Output:
	// &cc.InitializerList{
	// · Initializer: &cc.Initializer{
	// · · Expression: &cc.Expression{
	...
	// · · · · Value: 98,
	// · · · · Case: 1,
	// · · · · Token: example193.c:1:24: CHARCONST "'b'",
	// · · · },
	// · · },
	// · · Token: example193.c:1:22: ',',
	// · },
	// }
}

func ExampleIterationStatement() {
	fmt.Println(exampleAST(222, "\U00100002 auto a { while ( 'b' ) ; !"))
	// Output:
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example222.c:1:23: CHARCONST "'b'",
	// · · },
	// · },
	// · Statement: &cc.Statement{
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example222.c:1:29: ';',
	// · · },
	// · },
	// · Token: example222.c:1:15: WHILE "while",
	// · Token2: example222.c:1:21: '(',
	// · Token3: example222.c:1:27: ')',
	// }
}

func ExampleIterationStatement_case1() {
	fmt.Println(exampleAST(223, "\U00100002 auto a { do ; while ( 'b' ) ; !"))
	// Output:
	// &cc.IterationStatement{
	// · Case: 1,
	// · ExpressionList: &cc.ExpressionList{
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example223.c:1:28: CHARCONST "'b'",
	// · · },
	// · },
	// · Statement: &cc.Statement{
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example223.c:1:18: ';',
	// · · },
	// · },
	// · Token: example223.c:1:15: DO "do",
	// · Token2: example223.c:1:20: WHILE "while",
	// · Token3: example223.c:1:26: '(',
	// · Token4: example223.c:1:32: ')',
	// · Token5: example223.c:1:34: ';',
	// }
}

func ExampleIterationStatement_case2() {
	fmt.Println(exampleAST(224, "\U00100002 auto a { for ( ; ; ) ; !"))
	// Output:
	// &cc.IterationStatement{
	// · Case: 2,
	// · Statement: &cc.Statement{
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example224.c:1:27: ';',
	// · · },
	// · },
	// · Token: example224.c:1:15: FOR "for",
	// · Token2: example224.c:1:19: '(',
	// · Token3: example224.c:1:21: ';',
	// · Token4: example224.c:1:23: ';',
	// · Token5: example224.c:1:25: ')',
	// }
}

func ExampleIterationStatement_case3() {
	fmt.Println(exampleAST(225, "\U00100002 auto a { for ( auto ; ; ) ; !"))
	// Output:
	// &cc.IterationStatement{
	// · Case: 3,
	// · Declaration: &cc.Declaration{
	...
	// · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · Case: 3,
	// · · · · Token: example225.c:1:21: AUTO "auto",
	// · · · },
	// · · },
	...
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example225.c:1:32: ';',
	// · · },
	// · },
	// · Token: example225.c:1:15: FOR "for",
	// · Token2: example225.c:1:19: '(',
	// · Token3: example225.c:1:28: ';',
	// · Token4: example225.c:1:30: ')',
	// }
}

func ExampleJumpStatement() {
	fmt.Println(exampleAST(226, "\U00100002 auto a { goto b ; !"))
	// Output:
	// &cc.JumpStatement{
	// · Token: example226.c:1:15: GOTO "goto",
	// · Token2: example226.c:1:20: IDENTIFIER "b",
	// · Token3: example226.c:1:22: ';',
	// }
}

func ExampleJumpStatement_case1() {
	fmt.Println(exampleAST(227, "\U00100002 auto a { continue ; !"))
	// Output:
	// &cc.JumpStatement{
	// · Case: 1,
	// · Token: example227.c:1:15: CONTINUE "continue",
	// · Token2: example227.c:1:24: ';',
	// }
}

func ExampleJumpStatement_case2() {
	fmt.Println(exampleAST(228, "\U00100002 auto a { break ; !"))
	// Output:
	// &cc.JumpStatement{
	// · Case: 2,
	// · Token: example228.c:1:15: BREAK "break",
	// · Token2: example228.c:1:21: ';',
	// }
}

func ExampleJumpStatement_case3() {
	fmt.Println(exampleAST(229, "\U00100002 auto a { return ; !"))
	// Output:
	// &cc.JumpStatement{
	// · Case: 3,
	// · Token: example229.c:1:15: RETURN "return",
	// · Token2: example229.c:1:22: ';',
	// }
}
...
func ExampleLabeledStatement() {
	...
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example207.c:1:19: ';',
	// · · },
	// · },
	// · Token: example207.c:1:15: IDENTIFIER "b",
	// · Token2: example207.c:1:17: ':',
	// }
}

func ExampleLabeledStatement_case1() {
	fmt.Println(exampleAST(208, "\U00100002 auto a { case 'b' : ; !"))
	// Output:
	// &cc.LabeledStatement{
	// · Case: 1,
	// · ConstantExpression: &cc.ConstantExpression{
	...
	// · · },
	// · },
	// · Token: example208.c:1:15: CASE "case",
	// · Token2: example208.c:1:24: ':',
	// }
}
...
func ExampleParameterDeclaration() {
	fmt.Println(exampleAST(164, "\U00100001 ( _Bool ( auto a )"))
	// Output:
	...
	// · · Type: auto undefined,
	// · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · Token: example164.c:1:21: IDENTIFIER "a",
	// · · },
	// · },
	// }
}
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(163, "\U00100001 ( _Bool ( auto , auto )"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · Case: 1,
	...
	// · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · Case: 3,
	// · · · · · Token: example163.c:1:23: AUTO "auto",
	// · · · · },
	// · · · },
	// · · },
...
func ExampleParameterTypeList() {
	fmt.Println(exampleAST(158, "\U00100001 ( _Bool ( auto )"))
	// Output:
	...
	// · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · Case: 3,
	// · · · · · Token: example158.c:1:16: AUTO "auto",
	// · · · · },
	// · · · },
	// · · },
	// · },
...
func ExampleParameterTypeList_case1() {
	...
	// · · },
	// · },
	// · Token: example159.c:1:21: ',',
	// · Token2: example159.c:1:23: DDD,
	// }
}

func ExampleParameterTypeListOpt() {
	fmt.Println(exampleAST(160, "\U00100001 ( _Bool ( )") == (*ParameterTypeListOpt)(nil))
	// Output:
	// true
}

func ExampleParameterTypeListOpt_case1() {
	fmt.Println(exampleAST(161, "\U00100001 ( _Bool ( auto )"))
	// Output:
	...
	// · · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · · Case: 3,
	// · · · · · · Token: example161.c:1:16: AUTO "auto",
	// · · · · · },
	// · · · · },
	// · · · },
	// · · },
...
func ExamplePointer() {
	fmt.Println(exampleAST(150, "\U00100002 auto * ("))
	// Output:
	// &cc.Pointer{
...
func ExamplePointerOpt() {
	fmt.Println(exampleAST(152, "\U00100002 auto (") == (*PointerOpt)(nil))
	// Output:
	// true
}

func ExamplePointerOpt_case1() {
	fmt.Println(exampleAST(153, "\U00100001 ( _Bool * ("))
	// Output:
	// &cc.PointerOpt{
	// · Pointer: &cc.Pointer{
	// · · Token: example153.c:1:14: '*',
	// · },
	// }
}

func ExamplePreprocessingFile() {
	fmt.Println(exampleAST(240, "\U00100000 "))
	// Output:
...
func ExampleSelectionStatement() {
	fmt.Println(exampleAST(219, "\U00100002 auto a { if ( 'b' ) ; !"))
	// Output:
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example219.c:1:20: CHARCONST "'b'",
	// · · },
	// · },
	// · Statement: &cc.Statement{
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example219.c:1:26: ';',
	// · · },
	// · },
	// · Token: example219.c:1:15: IF "if",
	// · Token2: example219.c:1:18: '(',
	// · Token3: example219.c:1:24: ')',
	// }
}

func ExampleSelectionStatement_case1() {
	fmt.Println(exampleAST(220, "\U00100002 auto a { if ( 'b' ) ; else ; !"))
	// Output:
	// &cc.SelectionStatement{
	// · Case: 1,
	// · ExpressionList: &cc.ExpressionList{
...
func ExampleSelectionStatement_case2() {
	...
	// · · · Value: 98,
	// · · · Case: 1,
	// · · · Token: example221.c:1:24: CHARCONST "'b'",
	// · · },
	// · },
	// · Statement: &cc.Statement{
	// · · Case: 2,
	// · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · Token: example221.c:1:30: ';',
	// · · },
	// · },
	// · Token: example221.c:1:15: SWITCH "switch",
	// · Token2: example221.c:1:22: '(',
	// · Token3: example221.c:1:28: ')',
	// }
}

func ExampleSpecifierQualifierList() {
	fmt.Println(exampleAST(117, "\U00100001 ( _Bool ("))
	// Output:
	// &cc.SpecifierQualifierList{
	// · TypeSpecifier: &cc.TypeSpecifier{
	// · · Case: 9,
	// · · Token: example117.c:1:8: BOOL "_Bool",
	// · },
	// }
}

func ExampleSpecifierQualifierList_case1() {
	fmt.Println(exampleAST(118, "\U00100001 ( const ("))
	// Output:
	// &cc.SpecifierQualifierList{
	// · Case: 1,
	// · TypeQualifier: &cc.TypeQualifier{
	// · · Token: example118.c:1:8: CONST "const",
	// · },
	// }
}

func ExampleSpecifierQualifierListOpt() {
	fmt.Println(exampleAST(119, "\U00100001 ( _Bool (") == (*SpecifierQualifierListOpt)(nil))
	// Output:
	// true
}

func ExampleSpecifierQualifierListOpt_case1() {
	fmt.Println(exampleAST(120, "\U00100001 ( const _Bool ("))
	// Output:
	// &cc.SpecifierQualifierListOpt{
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
	// · · TypeSpecifier: &cc.TypeSpecifier{
	// · · · Case: 9,
	// · · · Token: example120.c:1:14: BOOL "_Bool",
	// · · },
	// · },
	// }
}
...
func ExampleStatement() {
	fmt.Println(exampleAST(201, "\U00100002 auto a { default : ; !"))
	// Output:
	// &cc.Statement{
	...
	// · · · Case: 2,
	// · · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · · Token: example201.c:1:25: ';',
	// · · · },
	// · · },
	// · · Token: example201.c:1:15: DEFAULT "default",
	// · · Token2: example201.c:1:23: ':',
	// · },
	// }
}
...
func ExampleStatement_case1() {
	...
	// · Case: 1,
	// · CompoundStatement: &cc.CompoundStatement{
	// · · Token: example202.c:1:15: '{',
	// · · Token2: example202.c:1:17: '}',
	// · },
	// }
}
...
func ExampleStatement_case3() {
	fmt.Println(exampleAST(204, "\U00100002 auto a { if ( 'b' ) ; !"))
	// Output:
	// &cc.Statement{
	// · Case: 3,
	...
	// · · · · Value: 98,
	// · · · · Case: 1,
	// · · · · Token: example204.c:1:20: CHARCONST "'b'",
	// · · · },
	// · · },
	// · · Statement: &cc.Statement{
	// · · · Case: 2,
	// · · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · · Token: example204.c:1:26: ';',
	// · · · },
	// · · },
	// · · Token: example204.c:1:15: IF "if",
	// · · Token2: example204.c:1:18: '(',
	// · · Token3: example204.c:1:24: ')',
	// · },
	// }
}

func ExampleStatement_case4() {
	fmt.Println(exampleAST(205, "\U00100002 auto a { while ( 'b' ) ; !"))
	// Output:
	// &cc.Statement{
	// · Case: 4,
	...
	// · · · · Value: 98,
	// · · · · Case: 1,
	// · · · · Token: example205.c:1:23: CHARCONST "'b'",
	// · · · },
	// · · },
	// · · Statement: &cc.Statement{
	// · · · Case: 2,
	// · · · ExpressionStatement: &cc.ExpressionStatement{
	// · · · · Token: example205.c:1:29: ';',
	// · · · },
	// · · },
	// · · Token: example205.c:1:15: WHILE "while",
	// · · Token2: example205.c:1:21: '(',
	// · · Token3: example205.c:1:27: ')',
	// · },
	// }
}

func ExampleStatement_case5() {
	fmt.Println(exampleAST(206, "\U00100002 auto a { break ; !"))
	// Output:
	// &cc.Statement{
	// · Case: 5,
	// · JumpStatement: &cc.JumpStatement{
	// · · Case: 2,
	// · · Token: example206.c:1:15: BREAK "break",
...
func ExampleStorageClassSpecifier() {
	fmt.Println(exampleAST(89, "\U00100002 typedef ("))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Token: example89.c:1:6: TYPEDEF "typedef",
	// }
}

func ExampleStorageClassSpecifier_case1() {
	fmt.Println(exampleAST(90, "\U00100002 extern ("))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: 1,
	// · Token: example90.c:1:6: EXTERN "extern",
	// }
}

func ExampleStorageClassSpecifier_case2() {
	fmt.Println(exampleAST(91, "\U00100002 static ("))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: 2,
	// · Token: example91.c:1:6: STATIC "static",
	// }
}

func ExampleStorageClassSpecifier_case3() {
	fmt.Println(exampleAST(92, "\U00100002 auto ("))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: 3,
	// · Token: example92.c:1:6: AUTO "auto",
	// }
}

func ExampleStorageClassSpecifier_case4() {
	fmt.Println(exampleAST(93, "\U00100002 register ("))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: 4,
	// · Token: example93.c:1:6: REGISTER "register",
	// }
}

func ExampleStructDeclaration() {
	fmt.Println(exampleAST(116, "\U00100002 struct { _Bool a ; }"))
	// Output:
...
func ExampleStructDeclarationList() {
	fmt.Println(exampleAST(114, "\U00100002 struct { _Bool a ; }"))
	// Output:
	...
	// · · · TypeSpecifier: &cc.TypeSpecifier{
	// · · · · Case: 9,
	// · · · · Token: example114.c:1:15: BOOL "_Bool",
	// · · · },
	// · · },
	// · · StructDeclaratorList: &cc.StructDeclaratorList{
	// · · · StructDeclarator: &cc.StructDeclarator{
	...
	// · · · · · Type: bool,
	// · · · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · · · Token: example114.c:1:21: IDENTIFIER "a",
	// · · · · · },
	// · · · · },
	// · · · },
	// · · },
	// · · Token: example114.c:1:23: ';',
	// · },
	// }
}

func ExampleStructDeclarationList_case1() {
	fmt.Println(exampleAST(115, "\U00100002 struct { _Bool a ; _Bool b ; }"))
	// Output:
	// &cc.StructDeclarationList{
	// · StructDeclaration: &cc.StructDeclaration{
	// · · SpecifierQualifierList: &cc.SpecifierQualifierList{
	...
	// · · · · TypeSpecifier: &cc.TypeSpecifier{
	// · · · · · Case: 9,
	// · · · · · Token: example115.c:1:25: BOOL "_Bool",
	// · · · · },
	// · · · },
	// · · · StructDeclaratorList: &cc.StructDeclaratorList{
	// · · · · StructDeclarator: &cc.StructDeclarator{
	...
	// · · · · · · Type: bool,
	// · · · · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · · · · Token: example115.c:1:31: IDENTIFIER "b",
	// · · · · · · },
	// · · · · · },
	// · · · · },
	// · · · },
	// · · · Token: example115.c:1:33: ';',
	// · · },
	// · },
	// }
}
...
func ExampleStructDeclarator_case1() {
	...
	// · · · Value: 97,
	// · · · Case: 1,
	// · · · Token: example124.c:1:23: CHARCONST "'a'",
	// · · },
	// · },
	// · Token: example124.c:1:21: ':',
	// }
}
...
func ExampleStructDeclaratorList_case1() {
	fmt.Println(exampleAST(122, "\U00100002 struct { _Bool a , b ,"))
	// Output:
	// &cc.StructDeclaratorList{
	// · StructDeclarator: &cc.StructDeclarator{
	// · · Declarator: &cc.Declarator{
	...
	// · · · · Type: bool,
	// · · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · · Token: example122.c:1:25: IDENTIFIER "b",
	// · · · · },
	// · · · },
	// · · },
	// · · Token: example122.c:1:23: ',',
	// · },
	// }
}

func ExampleStructOrUnion() {
	fmt.Println(exampleAST(112, "\U00100002 struct {"))
	// Output:
	// &cc.StructOrUnion{
...
func ExampleStructOrUnion_case1() {
	fmt.Println(exampleAST(113, "\U00100002 union {"))
	// Output:
	// &cc.StructOrUnion{
	// · Case: 1,
	// · Token: example113.c:1:6: UNION "union",
	// }
}

func ExampleStructOrUnionSpecifier() {
	fmt.Println(exampleAST(110, "\U00100002 struct { _Bool a ; } ("))
	// Output:
	...
	// · · · · · · Type: bool,
	// · · · · · · DirectDeclarator: &cc.DirectDeclarator{
	// · · · · · · · Token: example110.c:1:21: IDENTIFIER "a",
	// · · · · · · },
	// · · · · · },
	// · · · · },
	// · · · },
	// · · · Token: example110.c:1:23: ';',
	// · · },
	// · },
	// · StructOrUnion: &cc.StructOrUnion{
	// · · Token: example110.c:1:6: STRUCT "struct",
	// · },
	// · Token: example110.c:1:13: '{',
	// · Token2: example110.c:1:25: '}',
	// }
}
...
func ExampleStructOrUnionSpecifier_case1() {
	...
	// · },
	// · Token: example111.c:1:13: IDENTIFIER "a",
	// }
}

func ExampleTranslationUnit() {
	fmt.Println(exampleAST(230, "\U00100002 auto ;"))
	// Output:
	// &cc.TranslationUnit{
...
func ExampleTranslationUnit_case1() {
	fmt.Println(exampleAST(231, "\U00100002 auto ; auto ;"))
	// Output:
	// &cc.TranslationUnit{
	// · ExternalDeclaration: &cc.ExternalDeclaration{
	// · · Case: 1,
	...
	// · · · · · StorageClassSpecifier: &cc.StorageClassSpecifier{
	// · · · · · · Case: 3,
	// · · · · · · Token: example231.c:1:13: AUTO "auto",
	// · · · · · },
	// · · · · },
	// · · · · Token: example231.c:1:18: ';',
	// · · · },
	// · · },
	// · },
	// }
...
func ExampleTypeName() {
	fmt.Println(exampleAST(173, "\U00100001 ( _Bool )"))
	// Output:
	// &cc.TypeName{
	// · Type: bool,
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
	// · · TypeSpecifier: &cc.TypeSpecifier{
	// · · · Case: 9,
	// · · · Token: example173.c:1:8: BOOL "_Bool",
	// · · },
	// · },
	// }
}
...
func ExampleTypeQualifier() {
	fmt.Println(exampleAST(134, "\U00100002 const !"))
	// Output:
	// &cc.TypeQualifier{
	// · Token: example134.c:1:6: CONST "const",
	// }
}

func ExampleTypeQualifier_case1() {
	fmt.Println(exampleAST(135, "\U00100002 restrict !"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: 1,
	// · Token: example135.c:1:6: RESTRICT "restrict",
	// }
}

func ExampleTypeQualifier_case2() {
	fmt.Println(exampleAST(136, "\U00100002 volatile !"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: 2,
	// · Token: example136.c:1:6: VOLATILE "volatile",
	// }
}

func ExampleTypeQualifierList() {
	fmt.Println(exampleAST(154, "\U00100002 auto * const !"))
	// Output:
	// &cc.TypeQualifierList{
	// · TypeQualifier: &cc.TypeQualifier{
	// · · Token: example154.c:1:13: CONST "const",
	// · },
	// }
}

func ExampleTypeQualifierList_case1() {
	fmt.Println(exampleAST(155, "\U00100002 auto * const const !"))
	// Output:
	// &cc.TypeQualifierList{
	// · TypeQualifier: &cc.TypeQualifier{
	...
	// · · Case: 1,
	// · · TypeQualifier: &cc.TypeQualifier{
	// · · · Token: example155.c:1:19: CONST "const",
	// · · },
	// · },
	// }
}
...
func ExampleTypeQualifierListOpt() {
	fmt.Println(exampleAST(156, "\U00100002 auto * (") == (*TypeQualifierListOpt)(nil))
	// Output:
	// true
}

func ExampleTypeQualifierListOpt_case1() {
	fmt.Println(exampleAST(157, "\U00100002 auto * const !"))
	// Output:
	// &cc.TypeQualifierListOpt{
	// · TypeQualifierList: &cc.TypeQualifierList{
	// · · TypeQualifier: &cc.TypeQualifier{
	// · · · Token: example157.c:1:13: CONST "const",
	// · · },
	// · },
	// }
}
...
func ExampleTypeSpecifier() {
	fmt.Println(exampleAST(94, "\U00100002 void ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Token: example94.c:1:6: VOID "void",
	// }
}

func ExampleTypeSpecifier_case01() {
	fmt.Println(exampleAST(95, "\U00100002 char ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 1,
	// · Token: example95.c:1:6: CHAR "char",
	// }
}

func ExampleTypeSpecifier_case02() {
	fmt.Println(exampleAST(96, "\U00100002 short ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 2,
	// · Token: example96.c:1:6: SHORT "short",
	// }
}

func ExampleTypeSpecifier_case03() {
	fmt.Println(exampleAST(97, "\U00100002 int ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 3,
	// · Token: example97.c:1:6: INT "int",
	// }
}

func ExampleTypeSpecifier_case04() {
	fmt.Println(exampleAST(98, "\U00100002 long ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 4,
	// · Token: example98.c:1:6: LONG "long",
	// }
}

func ExampleTypeSpecifier_case05() {
	fmt.Println(exampleAST(99, "\U00100002 float ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 5,
	// · Token: example99.c:1:6: FLOAT "float",
	// }
}

func ExampleTypeSpecifier_case06() {
	fmt.Println(exampleAST(100, "\U00100002 double ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 6,
	// · Token: example100.c:1:6: DOUBLE "double",
	// }
}

func ExampleTypeSpecifier_case07() {
	fmt.Println(exampleAST(101, "\U00100002 signed ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 7,
	// · Token: example101.c:1:6: SIGNED "signed",
	// }
}

func ExampleTypeSpecifier_case08() {
	fmt.Println(exampleAST(102, "\U00100002 unsigned ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 8,
	// · Token: example102.c:1:6: UNSIGNED "unsigned",
	// }
}

func ExampleTypeSpecifier_case09() {
	fmt.Println(exampleAST(103, "\U00100002 _Bool ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 9,
	// · Token: example103.c:1:6: BOOL "_Bool",
	// }
}

func ExampleTypeSpecifier_case10() {
	fmt.Println(exampleAST(104, "\U00100002 _Complex ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 10,
	// · Token: example104.c:1:6: COMPLEX "_Complex",
	// }
}

func ExampleTypeSpecifier_case11() {
	fmt.Println(exampleAST(105, "\U00100002 struct a ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 11,
	...
	// · · Case: 1,
	// · · StructOrUnion: &cc.StructOrUnion{
	// · · · Token: example105.c:1:6: STRUCT "struct",
	// · · },
	// · · Token: example105.c:1:13: IDENTIFIER "a",
	// · },
	// }
}

func ExampleTypeSpecifier_case12() {
	fmt.Println(exampleAST(106, "\U00100002 enum a ("))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 12,
	// · EnumSpecifier: &cc.EnumSpecifier{
	// · · Case: 1,
	// · · Token: example106.c:1:6: ENUM "enum",
	// · · Token2: example106.c:1:11: IDENTIFIER "a",
	// · },
	// }
}

func ExampleTypeSpecifier_case13() {
	fmt.Println(exampleAST(107, "\U00100002 typedef int i; i j;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: 13,
	// · Token: example107.c:1:21: TYPEDEFNAME "i",
	// }
}
