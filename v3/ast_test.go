...
func ExampleAsm_case0() {
	fmt.Println(exampleAST(257, "__asm__(\"nop\");"))
	// Output:
	// &cc.Asm{
...
func ExampleAsmFunctionDefinition_case0() {
	fmt.Println(exampleAST(259, "int f() __asm__(\"nop\");"))
	// Output:
...
func ExampleAsmQualifier_volatile() {
	fmt.Println(exampleAST(260, "__asm__ volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifier_goto() {
	fmt.Println(exampleAST(262, "__asm__ goto (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifierList_case1() {
	fmt.Println(exampleAST(264, "__asm__ inline volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
	// · AsmQualifier: &cc.AsmQualifier{
	// · · Case: AsmQualifierInline,
...
func ExampleAsmStatement_case0() {
	fmt.Println(exampleAST(258, "void f() { __asm__(\"nop\"); }"))
	// Output:
	// &cc.AsmStatement{
	// · Asm: &cc.Asm{
...
func ExampleAtomicTypeSpecifier_case0() {
	fmt.Println(exampleAST(158, "_Atomic(int) i;"))
	// Output:
...
func ExampleAttributeSpecifierList_case1() {
	fmt.Println(exampleAST(274, "int i __attribute__((a)) __attribute((b));"))
	// Output:
	// &cc.AttributeSpecifierList{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleBlockItem_label() {
	fmt.Println(exampleAST(225, "int f() { __label__ L; }"))
	// Output:
	// &cc.BlockItem{
	// · Case: BlockItemLabel,
...
func ExampleBlockItem_funcDef() {
	fmt.Println(exampleAST(226, "int f() { int g() {} }"))
	// Output:
	// &cc.BlockItem{
...
func ExampleBlockItem_pragma() {
	fmt.Println(exampleAST(227, "int f() {\\n#pragma STDC FENV_ACCESS OFF\\n}"))
	// Output:
	// &cc.BlockItem{
...
func ExampleDeclarationList_case0() {
	fmt.Println(exampleAST(250, "int f(i) int i; {}"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleDeclarationList_case1() {
	fmt.Println(exampleAST(251, "int f(i, j) int i; int j; {}"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(205, "int a[100][] = { [42][12] = 314 };"))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Case: DesignatorIndex,
...
func ExampleDirectAbstractDeclarator_arr() {
	fmt.Println(exampleAST(194, "void f(int[const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_staticArr() {
	fmt.Println(exampleAST(195, "void f(int[static const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_arrStatic() {
	fmt.Println(exampleAST(196, "void f(int[const static 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_func() {
	fmt.Println(exampleAST(198, "void f(int(char));"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: DirectAbstractDeclaratorFunc,
...
func ExampleEnumSpecifier_tag() {
	fmt.Println(exampleAST(153, "enum e i;"))
	// Output:
	// &cc.EnumSpecifier{
...
func ExampleEnumerator_expr() {
	fmt.Println(exampleAST(157, "enum e {a = 42};"))
	// Output:
	// &cc.Enumerator{
	// · Case: EnumeratorExpr,
	// · ConstantExpression: &cc.ConstantExpression{
...
func ExampleEnumeratorList_case1() {
	fmt.Println(exampleAST(155, "enum e {a, b};"))
	// Output:
	// &cc.EnumeratorList{
	// · Enumerator: &cc.Enumerator{
	// · · Case: EnumeratorIdent,
...
func ExampleExpressionList_case1() {
	fmt.Println(exampleAST(267, "int i __attribute__((a(b, c)));"))
	// Output:
	// &cc.ExpressionList{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleExternalDeclaration_decl() {
	fmt.Println(exampleAST(244, "int i;"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleExternalDeclaration_asm() {
	fmt.Println(exampleAST(245, "int f() __asm__(\"nop\");"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleExternalDeclaration_asmStmt() {
	fmt.Println(exampleAST(246, "__asm__(\"nop\");"))
	// Output:
	// &cc.ExternalDeclaration{
	// · AsmStatement: &cc.AsmStatement{
	// · · Asm: &cc.Asm{
...
func ExampleExternalDeclaration_pragma() {
	fmt.Println(exampleAST(248, "#pragma STDC CX_LIMITED_RANGE DEFAULT"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleIdentifierList_case0() {
	fmt.Println(exampleAST(188, "int f(i) int i; {}"))
	// Output:
	// &cc.IdentifierList{
...
func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(189, "int f(i, j) int i, j; {}"))
	// Output:
	// &cc.IdentifierList{
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example.c:1:8: ',' ",",
...
func ExampleInitializerList_case0() {
	fmt.Println(exampleAST(201, "int i[] = { [10] = x };"))
	// Output:
	// &cc.InitializerList{
...
func ExampleInitializerList_case1() {
	fmt.Println(exampleAST(202, "int i[] = { [10] = x, [20] = y };"))
	// Output:
	// &cc.InitializerList{
	// · Designation: &cc.Designation{
	// · · DesignatorList: &cc.DesignatorList{
...
func ExampleLabelDeclaration_case0() {
	fmt.Println(exampleAST(265, "int f() { __label__ L; L: x(); }"))
	// Output:
	// &cc.LabelDeclaration{
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example.c:1:21: IDENTIFIER "L",
...
func ExampleParameterDeclaration_abstract() {
	fmt.Println(exampleAST(187, "int f(int*) {}"))
	// Output:
	// &cc.ParameterDeclaration{
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(185, "int f(int i, int j) {}"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · Case: ParameterDeclarationDecl,
...
func ExamplePragmaSTDC_case0() {
	fmt.Println(exampleAST(275, "_Pragma(\"STDC FP_CONTRACT ON\")"))
	// Output:
	// &cc.PragmaSTDC{
	// · Token: example.c:1:9: PPPRAGMASTDC "__pragma_stdc",
	// · Token2: example.c:1:9: IDENTIFIER "STDC",
...
func ExampleSpecifierQualifierList_attribute() {
	fmt.Println(exampleAST(147, "struct {__attribute__((a)) int i;};"))
	// Output:
	// &cc.SpecifierQualifierList{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleStatement_expr() {
	fmt.Println(exampleAST(211, "int f() { x(); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementExpr,
	// · ExpressionStatement: &cc.ExpressionStatement{
...
func ExampleStatement_asm() {
	fmt.Println(exampleAST(215, "int f() { __asm__(\"nop\"); }"))
	// Output:
	// &cc.Statement{
	// · AsmStatement: &cc.AsmStatement{
	// · · Asm: &cc.Asm{
...
func ExampleStructDeclarator_bitField() {
	fmt.Println(exampleAST(151, "struct{ int i:3; }"))
	// Output:
	// &cc.StructDeclarator{
...
func ExampleStructDeclaratorList_case1() {
	fmt.Println(exampleAST(149, "struct{ int i, j; }"))
	// Output:
	// &cc.StructDeclaratorList{
	// · StructDeclarator: &cc.StructDeclarator{
	// · · Case: StructDeclaratorDecl,
...
func ExampleTypeName_case0() {
	fmt.Println(exampleAST(190, "int i = (int)x;"))
	// Output:
	// &cc.TypeName{
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
	// · · Case: SpecifierQualifierListTypeSpec,
...
func ExampleTypeQualifier_const() {
	fmt.Println(exampleAST(159, "const int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierConst,
...
func ExampleTypeQualifier_restrict() {
	fmt.Println(exampleAST(160, "restrict int i;"))
	// Output:
	// &cc.TypeQualifier{
...
func ExampleTypeQualifier_volatile() {
	fmt.Println(exampleAST(161, "volatile int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierVolatile,
	// · Token: example.c:1:1: VOLATILE "volatile",
...
func ExampleTypeQualifiers_typeQual() {
	fmt.Println(exampleAST(178, "int * const i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeQualifiers_attribute() {
	fmt.Println(exampleAST(179, "int * __attribute__((a)) i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleTypeQualifiers_case3() {
	fmt.Println(exampleAST(181, "int * __attribute__((a)) __attribute__((b)) i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
