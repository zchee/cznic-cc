...
const _tokCh_name = "'+=''_Alignas''_Alignof''&&''&=''->''__asm''_Atomic''__attribute__''auto''__auto_type''_Bool''break''case''char'character constant'_Complex''const''continue''...''--''_Decimal128''_Decimal32''_Decimal64''__declspec''default''/=''do''double''else''enum''==''extern''float''_Float128''_Float128x''_Float16''_Float32''_Float32x''_Float64''_Float64x'floating point constant'for''_Generic''>=''goto'<header-name>identifier'if''__imag__''_Imaginary''++''inline''int''__int128'integer constant'__label__''<=''long'long character constantlong string literal'<<''<<=''%=''*=''!=''_Nonnull''_Noreturn''|=''||'preprocessing number'##''__real__''register''restrict''return''>>''>>=''short''signed''sizeof''static'_Static_assertstring literal'struct''-=''switch''_Thread_local''typedef'type name'typeof''__uint128_t''union''unsigned''void''volatile''while''^='"

var _tokCh_index = [...]uint16{0, 4, 14, 24, 28, 32, 36, 43, 52, 67, 73, 86, 93, 100, 106, 112, 130, 140, 147, 157, 162, 166, 179, 191, 203, 215, 224, 228, 232, 240, 246, 252, 256, 264, 271, 282, 294, 304, 314, 325, 335, 346, 369, 374, 384, 388, 394, 407, 417, 421, 431, 443, 447, 455, 460, 470, 486, 497, 501, 507, 530, 549, 553, 558, 562, 566, 570, 580, 591, 595, 599, 619, 623, 633, 643, 653, 661, 665, 670, 677, 685, 693, 701, 715, 729, 737, 741, 749, 764, 773, 782, 790, 803, 810, 820, 826, 836, 843, 847}
