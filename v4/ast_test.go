...
func ExampleAlignmentSpecifier_type() {
	fmt.Println(exampleAST(168, "_Alignas(double) char c;"))
	// Output:
...
func ExampleAlignmentSpecifier_expr() {
	fmt.Println(exampleAST(169, "_Alignas(0ll) char c;"))
	// Output:
	// &cc.AlignmentSpecifier{
...
func ExampleAsm_case0() {
	fmt.Println(exampleAST(257, "asm(\"nop\");"))
	// Output:
	// &cc.Asm{
...
func ExampleAsmQualifier_volatile() {
	fmt.Println(exampleAST(259, "asm volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifier_goto() {
	fmt.Println(exampleAST(261, "asm goto (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifierList_case1() {
	fmt.Println(exampleAST(263, "asm inline volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
	// · AsmQualifier: &cc.AsmQualifier{
	// · · Case: AsmQualifierInline,
...
func ExampleAsmStatement_case0() {
	fmt.Println(exampleAST(258, "void f() { asm(\"nop\"); }"))
	// Output:
	// &cc.AsmStatement{
	// · Asm: &cc.Asm{
...
func ExampleAttributeSpecifierList_case1() {
	fmt.Println(exampleAST(270, "int i __attribute__((a)) __attribute__((b));"))
	// Output:
	// &cc.AttributeSpecifierList{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleBlockItem_label() {
	fmt.Println(exampleAST(227, "int f() { __label__ L; int i; }"))
	// Output:
	// &cc.BlockItem{
	// · Case: BlockItemDecl,
	// · Declaration: &cc.Declaration{
...
func ExampleBlockItem_funcDef() {
	fmt.Println(exampleAST(229, "int f() { int g() {} }"))
	// Output:
	// &cc.BlockItem{
	// · Case: BlockItemDecl,
	// · Declaration: &cc.Declaration{
...
func ExampleBlockItemList_case1() {
	fmt.Println(exampleAST(225, "int f() { int i; double j; }"))
	// Output:
	// &cc.BlockItemList{
	// · BlockItem: &cc.BlockItem{
	// · · Case: BlockItemDecl,
...
func ExampleCompoundStatement_case0() {
	fmt.Println(exampleAST(222, "int f() { __label__ L; int i; }"))
	// Output:
...
func ExampleDeclarator_case0() {
	fmt.Println(exampleAST(167, "int *p;"))
	// Output:
	// &cc.Declarator{
	// · DirectDeclarator: &cc.DirectDeclarator{
	// · · Case: DirectDeclaratorIdent,
...
func ExampleDesignator_index2() {
	fmt.Println(exampleAST(208, "int a[] = { [42 ... 278] = 314 };"))
	// Output:
	// &cc.Designator{
...
func ExampleDirectDeclarator_ident() {
	fmt.Println(exampleAST(170, "int i;"))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: DirectDeclaratorIdent,
	// · Token: example.c:1:5: identifier "i",
...
func ExampleDirectDeclarator_decl() {
	fmt.Println(exampleAST(171, "int (f);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arr() {
	fmt.Println(exampleAST(172, "int i[const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.PrimaryExpression{
	// · · Case: PrimaryExpressionInt,
...
func ExampleDirectDeclarator_staticArr() {
	fmt.Println(exampleAST(173, "int i[static const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.PrimaryExpression{
	// · · Case: PrimaryExpressionInt,
...
func ExampleDirectDeclarator_arrStatic() {
	fmt.Println(exampleAST(174, "int i[const static 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.PrimaryExpression{
	// · · Case: PrimaryExpressionInt,
...
func ExampleDirectDeclarator_star() {
	fmt.Println(exampleAST(175, "int i[const *];"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_funcIdent() {
	fmt.Println(exampleAST(177, "int f(a);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleExternalDeclaration_decl() {
	fmt.Println(exampleAST(246, "register int i asm(\"r0\");"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleFunctionSpecifier_inline() {
	fmt.Println(exampleAST(165, "inline int f() {}"))
	// Output:
...
func ExampleFunctionSpecifier_noreturn() {
	fmt.Println(exampleAST(166, "_Noreturn int f() {}"))
	// Output:
	// &cc.FunctionSpecifier{
...
func ExampleLabelDeclaration_case0() {
	fmt.Println(exampleAST(223, "int f() { __label__ L, M; L: x(); M: y(); }"))
	// Output:
	// &cc.LabelDeclaration{
	// · IdentifierList: &cc.IdentifierList{
	// · · IdentifierList: &cc.IdentifierList{
...
func ExampleParameterDeclaration_decl() {
	fmt.Println(exampleAST(187, "int f(int i __attribute__((a))) {}"))
	// Output:
...
func ExamplePointer_ptr() {
	fmt.Println(exampleAST(179, "int **p;"))
	// Output:
	// &cc.Pointer{
	// · Case: PointerPtr,
	// · Pointer: &cc.Pointer{
...
func ExamplePointer_block() {
	fmt.Println(exampleAST(180, "int atexit_b(void (^ _Nonnull)(void));"))
	// Output:
	// &cc.Pointer{
	// · Case: PointerBlock,
...
func ExampleStatement_expr() {
	fmt.Println(exampleAST(213, "int f() { __attribute__((a)); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementExpr,
	// · ExpressionStatement: &cc.ExpressionStatement{
...
func ExampleStatement_asm() {
	fmt.Println(exampleAST(217, "int f() { asm(\"nop\"); }"))
	// Output:
	// &cc.Statement{
	// · AsmStatement: &cc.AsmStatement{
	// · · Asm: &cc.Asm{
...
func ExampleStructDeclaration_assert() {
	fmt.Println(exampleAST(144, "struct{ int i; _Static_assert(x > y, \"abc\"); }"))
	// Output:
	// <nil>
}
...
func ExampleTypeQualifier_nonnull() {
	fmt.Println(exampleAST(163, "_Nonnull int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierNonnull,
...
func ExampleTypeQualifier_attr() {
	fmt.Println(exampleAST(164, "struct { __attribute__((a)) int i; };"))
	// Output:
	// &cc.TypeQualifier{
	// · AttributeSpecifierList: &cc.AttributeSpecifierList{
	// · · AttributeSpecifier: &cc.AttributeSpecifier{
...
func ExampleTypeQualifiers_typeQual() {
	fmt.Println(exampleAST(181, "int * __attribute__((a)) const i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeSpecifier_decimal64() {
	fmt.Println(exampleAST(118, "_Decimal64 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float128() {
	fmt.Println(exampleAST(119, "_Float128 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float128x() {
	fmt.Println(exampleAST(120, "_Float128x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_double() {
	fmt.Println(exampleAST(121, "double i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierDouble,
...
func ExampleTypeSpecifier_signed() {
	fmt.Println(exampleAST(122, "signed i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_unsigned() {
	fmt.Println(exampleAST(123, "unsigned i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_bool() {
	fmt.Println(exampleAST(124, "_Bool i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_complex() {
	fmt.Println(exampleAST(125, "_Complex i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_imaginary() {
	fmt.Println(exampleAST(126, "_Imaginary i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_structOrUnion() {
	fmt.Println(exampleAST(127, "struct s i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_enum() {
	fmt.Println(exampleAST(128, "enum e i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_typeName() {
	fmt.Println(exampleAST(129, "typedef int T; T i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:9: 'int' "int",
...
func ExampleTypeSpecifier_typeofExpr() {
	fmt.Println(exampleAST(130, "typeof(42) i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_typeofType() {
	fmt.Println(exampleAST(131, "typedef int T; typeof(T) i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:9: 'int' "int",
