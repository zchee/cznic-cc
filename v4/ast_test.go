...
func ExampleAbstractDeclarator_ptr() {
	fmt.Println(exampleAST(171, "void f(int*);"))
	// Output:
...
func ExampleAbstractDeclarator_decl() {
	fmt.Println(exampleAST(172, "void f(int());"))
	// Output:
	// &cc.AbstractDeclarator{
...
func ExampleAsm_case0() {
	fmt.Println(exampleAST(231, "asm(\"nop\");"))
	// Output:
	// &cc.Asm{
...
func ExampleAsmArgList_case0() {
	fmt.Println(exampleAST(229, "asm(\"nop\": a);"))
	// Output:
	// &cc.AsmArgList{
...
func ExampleAsmArgList_case1() {
	fmt.Println(exampleAST(230, "asm(\"nop\": a : b);"))
	// Output:
	// &cc.AsmArgList{
...
func ExampleAsmExpressionList_case0() {
	fmt.Println(exampleAST(227, "asm(\"nop\": a);"))
	// Output:
...
func ExampleAsmExpressionList_case1() {
	fmt.Println(exampleAST(228, "asm(\"nop\": a, b);"))
	// Output:
	// &cc.AsmExpressionList{
	// · AsmExpressionList: &cc.AsmExpressionList{
	// · · AssignmentExpression: &cc.AssignmentExpression{
...
func ExampleAsmIndex_case0() {
	fmt.Println(exampleAST(226, "asm(\"nop\": [a] b);"))
	// Output:
	// &cc.AsmIndex{
...
func ExampleAsmQualifier_volatile() {
	fmt.Println(exampleAST(233, "asm volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifier_inline() {
	fmt.Println(exampleAST(234, "asm inline (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifier_goto() {
	fmt.Println(exampleAST(235, "asm goto (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifierList_case0() {
	fmt.Println(exampleAST(236, "asm inline (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
...
func ExampleAsmQualifierList_case1() {
	fmt.Println(exampleAST(237, "asm inline volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
	// · AsmQualifier: &cc.AsmQualifier{
	// · · Case: AsmQualifierInline,
...
func ExampleAsmStatement_case0() {
	fmt.Println(exampleAST(232, "void f() { asm(\"nop\"); }"))
	// Output:
	// &cc.AsmStatement{
	// · Asm: &cc.Asm{
...
func ExampleAtomicTypeSpecifier_case0() {
	fmt.Println(exampleAST(141, "_Atomic(int) i;"))
	// Output:
...
func ExampleAttributeSpecifier_case0() {
	fmt.Println(exampleAST(243, "int i __attribute__((a));"))
	// Output:
...
func ExampleAttributeSpecifierList_case0() {
	fmt.Println(exampleAST(244, "int i __attribute__((a));"))
	// Output:
...
func ExampleAttributeSpecifierList_case1() {
	fmt.Println(exampleAST(245, "int i __attribute__((a)) __attribute__((b));"))
	// Output:
	// &cc.AttributeSpecifierList{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleAttributeValue_ident() {
	fmt.Println(exampleAST(239, "int i __attribute__((a));"))
	// Output:
	// &cc.AttributeValue{
	// · Case: AttributeValueIdent,
	// · Token: example.c:1:22: IDENTIFIER "a",
...
func ExampleAttributeValue_expr() {
	fmt.Println(exampleAST(240, "int i __attribute__((a(b)));"))
	// Output:
	// &cc.AttributeValue{
	// · ArgumentExpressionList: &cc.ArgumentExpressionList{
	// · · AssignmentExpression: &cc.AssignmentExpression{
...
func ExampleAttributeValueList_case0() {
	fmt.Println(exampleAST(241, "int i __attribute__((a));"))
	// Output:
...
func ExampleAttributeValueList_case1() {
	fmt.Println(exampleAST(242, "int i __attribute__((a, b));"))
	// Output:
	// &cc.AttributeValueList{
	// · AttributeValue: &cc.AttributeValue{
	// · · Case: AttributeValueIdent,
...
func ExampleBlockItem_decl() {
	fmt.Println(exampleAST(202, "int f() { int i; }"))
	// Output:
	// &cc.BlockItem{
	// · Case: BlockItemDecl,
...
func ExampleBlockItem_stmt() {
	fmt.Println(exampleAST(203, "int f() { g(); }"))
	// Output:
	// &cc.BlockItem{
	// · Case: BlockItemStmt,
...
func ExampleBlockItem_funcDef() {
	fmt.Println(exampleAST(204, "int f() { int g() {} }"))
	// Output:
	// &cc.BlockItem{
...
func ExampleBlockItemList_case0() {
	fmt.Println(exampleAST(200, "int f() { int i; }"))
	// Output:
	// &cc.BlockItemList{
...
func ExampleBlockItemList_case1() {
	fmt.Println(exampleAST(201, "int f() { int i; double j; }"))
	// Output:
	// &cc.BlockItemList{
	// · BlockItem: &cc.BlockItem{
	// · · Case: BlockItemDecl,
...
func ExampleCastExpression_unary() {
	fmt.Println(exampleAST(35, "int i = 42;"))
	// Output:
	// &cc.CastExpression{
	// · Case: CastExpressionUnary,
	// · UnaryExpression: &cc.UnaryExpression{
...
func ExampleCastExpression_cast() {
	fmt.Println(exampleAST(36, "int i = (__attribute__((a)) int)3.14;"))
	// Output:
	// &cc.CastExpression{
...
func ExampleCompoundStatement_case0() {
	fmt.Println(exampleAST(199, "int f() { __label__ L; int i; }"))
	// Output:
...
func ExampleConditionalExpression_cond() {
	fmt.Println(exampleAST(66, "int i = x ? y : z;"))
	// Output:
	// &cc.ConditionalExpression{
...
func ExampleConstantExpression_case0() {
	fmt.Println(exampleAST(81, "struct { int i:3; };"))
	// Output:
...
func ExampleDeclaration_case0() {
	fmt.Println(exampleAST(82, "int i, j __attribute__((a));"))
	// Output:
	// &cc.Declaration{
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
	// · · Case: DeclarationSpecifiersTypeSpec,
...
func ExampleDeclarationList_case0() {
	fmt.Println(exampleAST(224, "int f(i) int i; {}"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleDeclarationList_case1() {
	fmt.Println(exampleAST(225, "int f(i, j) int i; int j; {}"))
	// Output:
	// &cc.DeclarationList{
	// · Declaration: &cc.Declaration{
	// · · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleDeclarationSpecifiers_storage() {
	fmt.Println(exampleAST(83, "__attribute__((a)) static int i;"))
	// Output:
	...
	// · · },
	// · },
	// · Case: DeclarationSpecifiersCase(4),
	// · DeclarationSpecifiers: &cc.DeclarationSpecifiers{
...
func ExampleDeclarationSpecifiers_typeQual() {
	fmt.Println(exampleAST(85, "volatile int i;"))
	// Output:
	// &cc.DeclarationSpecifiers{
...
func ExampleDeclarationSpecifiers_func() {
	fmt.Println(exampleAST(86, "inline int f() {}"))
	// Output:
	// &cc.DeclarationSpecifiers{
...
func ExampleDeclarator_case0() {
	fmt.Println(exampleAST(148, "int *p;"))
	// Output:
	// &cc.Declarator{
	// · DirectDeclarator: &cc.DirectDeclarator{
	// · · Case: DirectDeclaratorIdent,
...
func ExampleDesignation_case0() {
	fmt.Println(exampleAST(183, "int a[] = { [42] = 314 };"))
	// Output:
	// &cc.Designation{
...
func ExampleDesignator_index() {
	fmt.Println(exampleAST(186, "int a[] = { [42] = 314 };"))
	// Output:
	// &cc.Designator{
	// · Case: DesignatorIndex,
	// · ConstantExpression: &cc.ConstantExpression{
...
func ExampleDesignator_field() {
	fmt.Println(exampleAST(187, "struct t s = { .fld = 314 };"))
	// Output:
	// &cc.Designator{
...
func ExampleDesignator_field2() {
	fmt.Println(exampleAST(188, "struct t s = { fld: 314 };"))
	// Output:
	// &cc.Designator{
...
func ExampleDesignatorList_case0() {
	fmt.Println(exampleAST(184, "int a[] = { [42] = 314 };"))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Case: DesignatorIndex,
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(185, "int a[100][] = { [42][12] = 314 };"))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Case: DesignatorIndex,
...
func ExampleDirectAbstractDeclarator_decl() {
	fmt.Println(exampleAST(173, "void f(int(*));"))
	// Output:
...
func ExampleDirectAbstractDeclarator_arr() {
	fmt.Println(exampleAST(174, "void f(int[const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_staticArr() {
	fmt.Println(exampleAST(175, "void f(int[static const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_arrStatic() {
	fmt.Println(exampleAST(176, "void f(int[const static 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_arrStar() {
	fmt.Println(exampleAST(177, "void f(int[*]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
...
func ExampleDirectAbstractDeclarator_func() {
	fmt.Println(exampleAST(178, "void f(int(char));"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: DirectAbstractDeclaratorFunc,
...
func ExampleDirectDeclarator_ident() {
	fmt.Println(exampleAST(149, "int i;"))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: DirectDeclaratorIdent,
	// · Token: example.c:1:5: IDENTIFIER "i",
...
func ExampleDirectDeclarator_decl() {
	fmt.Println(exampleAST(150, "int (f);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arr() {
	fmt.Println(exampleAST(151, "int i[const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_staticArr() {
	fmt.Println(exampleAST(152, "int i[static const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_arrStatic() {
	fmt.Println(exampleAST(153, "int i[const static 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_star() {
	fmt.Println(exampleAST(154, "int i[const *];"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_funcParam() {
	fmt.Println(exampleAST(155, "int f(int i);"))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: DirectDeclaratorFuncParam,
	// · DirectDeclarator: &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_funcIdent() {
	fmt.Println(exampleAST(156, "int f(a);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleEnumSpecifier_def() {
	fmt.Println(exampleAST(135, "enum e {a};"))
	// Output:
	// &cc.EnumSpecifier{
...
func ExampleEnumSpecifier_tag() {
	fmt.Println(exampleAST(136, "enum e i;"))
	// Output:
	// &cc.EnumSpecifier{
...
func ExampleEnumerator_ident() {
	fmt.Println(exampleAST(139, "enum e {a};"))
	// Output:
	// &cc.Enumerator{
	// · Case: EnumeratorIdent,
	// · Token: example.c:1:9: IDENTIFIER "a",
...
func ExampleEnumerator_expr() {
	fmt.Println(exampleAST(140, "enum e {a = 42};"))
	// Output:
	// &cc.Enumerator{
	// · Case: EnumeratorExpr,
	// · ConstantExpression: &cc.ConstantExpression{
...
func ExampleEnumeratorList_case0() {
	fmt.Println(exampleAST(137, "enum e {a};"))
	// Output:
	// &cc.EnumeratorList{
	// · Enumerator: &cc.Enumerator{
	// · · Case: EnumeratorIdent,
...
func ExampleEnumeratorList_case1() {
	fmt.Println(exampleAST(138, "enum e {a, b};"))
	// Output:
	// &cc.EnumeratorList{
	// · Enumerator: &cc.Enumerator{
	// · · Case: EnumeratorIdent,
...
func ExampleExpression_assign() {
	fmt.Println(exampleAST(79, "int f() { i = x; };"))
	// Output:
	// &cc.Expression{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · AssignmentExpression: &cc.AssignmentExpression{
...
func ExampleExpressionStatement_case0() {
	fmt.Println(exampleAST(205, "int f() { g(); }"))
	// Output:
...
func ExampleExternalDeclaration_decl() {
	fmt.Println(exampleAST(220, "register int i asm(\"r0\");"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleFunctionDefinition_case0() {
	fmt.Println(exampleAST(223, "int f() {}"))
	// Output:
...
func ExampleFunctionSpecifier_inline() {
	fmt.Println(exampleAST(146, "inline int f() {}"))
	// Output:
...
func ExampleFunctionSpecifier_noreturn() {
	fmt.Println(exampleAST(147, "_Noreturn int f() {}"))
	// Output:
	// &cc.FunctionSpecifier{
...
func ExampleIdentifierList_case0() {
	fmt.Println(exampleAST(168, "int f(i) int i; {}"))
	// Output:
	// &cc.IdentifierList{
...
func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(169, "int f(i, j) int i, j; {}"))
	// Output:
	// &cc.IdentifierList{
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example.c:1:8: ',' ",",
...
func ExampleInitDeclaratorList_case1() {
	fmt.Println(exampleAST(88, "int i, __attribute__((a)) j;"))
	// Output:
	// &cc.InitDeclaratorList{
	// · InitDeclarator: &cc.InitDeclarator{
	// · · Case: InitDeclaratorDecl,
...
func ExampleInitializer_expr() {
	fmt.Println(exampleAST(179, "int i = x;"))
	// Output:
	// &cc.Initializer{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleInitializer_initList() {
	fmt.Println(exampleAST(180, "int i[] = { x };"))
	// Output:
	// &cc.Initializer{
	// · Case: InitializerExpr,
...
func ExampleInitializerList_case0() {
	fmt.Println(exampleAST(181, "int i[] = { [10] = x };"))
	// Output:
	// &cc.InitializerList{
...
func ExampleInitializerList_case1() {
	fmt.Println(exampleAST(182, "int i[] = { [10] = x, [20] = y };"))
	// Output:
	// &cc.InitializerList{
	// · Designation: &cc.Designation{
	// · · DesignatorList: &cc.DesignatorList{
...
func ExampleIterationStatement_while() {
	fmt.Println(exampleAST(209, "int f() { while(x) y(); }"))
	// Output:
...
func ExampleIterationStatement_do() {
	fmt.Println(exampleAST(210, "int f() { do x(); while(y); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleIterationStatement_for() {
	fmt.Println(exampleAST(211, "int f() { for( i = 0; i < 10; i++) x(); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleIterationStatement_forDecl() {
	fmt.Println(exampleAST(212, "int f() { for( int i = 0; i < 10; i++) x(); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleJumpStatement_goto() {
	fmt.Println(exampleAST(213, "int f() { L: goto L; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_continue() {
	fmt.Println(exampleAST(214, "int f() { for(;;) if (i) continue; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_break() {
	fmt.Println(exampleAST(215, "int f() { for(;;) if (i) break; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_return() {
	fmt.Println(exampleAST(216, "int f() { if (i) return x; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleLabelDeclaration_case0() {
	fmt.Println(exampleAST(238, "int f() { __label__ L, M; L: x(); M: y(); }"))
	// Output:
	// &cc.LabelDeclaration{
	// · IdentifierList: &cc.IdentifierList{
	// · · IdentifierList: &cc.IdentifierList{
...
func ExampleLabeledStatement_label() {
	fmt.Println(exampleAST(196, "int f() { L: goto L; }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleLabeledStatement_caseLabel() {
	fmt.Println(exampleAST(197, "int f() { switch(i) case 42: x(); }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleLabeledStatement_default() {
	fmt.Println(exampleAST(198, "int f() { switch(i) default: x(); }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleMultiplicativeExpression_cast() {
	fmt.Println(exampleAST(37, "int i = x;"))
	// Output:
...
func ExampleParameterDeclaration_decl() {
	fmt.Println(exampleAST(166, "int f(int i __attribute__((a))) {}"))
	// Output:
...
func ExampleParameterDeclaration_abstract() {
	fmt.Println(exampleAST(167, "int f(int*) {}"))
	// Output:
	// &cc.ParameterDeclaration{
	// · AbstractDeclarator: &cc.AbstractDeclarator{
	// · · Case: AbstractDeclaratorPtr,
...
func ExampleParameterList_case0() {
	fmt.Println(exampleAST(164, "int f(int i) {}"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · Case: ParameterDeclarationDecl,
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(165, "int f(int i, int j) {}"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · Case: ParameterDeclarationDecl,
...
func ExampleParameterTypeList_list() {
	fmt.Println(exampleAST(162, "int f(int i) {}"))
	// Output:
...
func ExamplePointer_ptr() {
	fmt.Println(exampleAST(158, "int **p;"))
	// Output:
	// &cc.Pointer{
	// · Case: PointerTypeQual,
	// · Pointer: &cc.Pointer{
...
func ExamplePointer_block() {
	fmt.Println(exampleAST(159, "int atexit_b(void (^ _Nonnull)(void));"))
	// Output:
	// &cc.Pointer{
	// · Case: PointerBlock,
...
func ExampleSelectionStatement_if() {
	fmt.Println(exampleAST(206, "int f() { if(x) y(); }"))
	// Output:
...
func ExampleSelectionStatement_ifElse() {
	fmt.Println(exampleAST(207, "int f() { if(x) y(); else z(); }"))
	// Output:
	// &cc.SelectionStatement{
...
func ExampleSpecifierQualifierList_typeSpec() {
	fmt.Println(exampleAST(129, "struct {int i;};"))
	// Output:
...
func ExampleSpecifierQualifierList_typeQual() {
	fmt.Println(exampleAST(130, "struct {const int i;};"))
	// Output:
	// &cc.SpecifierQualifierList{
	// · Case: SpecifierQualifierListTypeSpec,
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
...
func ExampleStatement_labeled() {
	fmt.Println(exampleAST(189, "int f() { L: x(); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementLabeled,
	// · LabeledStatement: &cc.LabeledStatement{
...
func ExampleStatement_compound() {
	fmt.Println(exampleAST(190, "int f() { { y(); } }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_expr() {
	fmt.Println(exampleAST(191, "int f() { __attribute__((a)); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementExpr,
	// · ExpressionStatement: &cc.ExpressionStatement{
...
func ExampleStatement_selection() {
	fmt.Println(exampleAST(192, "int f() { if(x) y(); }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_iteration() {
	fmt.Println(exampleAST(193, "int f() { for(;;) x(); }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_jump() {
	fmt.Println(exampleAST(194, "int f() { return x; }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementJump,
	// · JumpStatement: &cc.JumpStatement{
...
func ExampleStatement_asm() {
	fmt.Println(exampleAST(195, "int f() { asm(\"nop\"); }"))
	// Output:
	// &cc.Statement{
	// · AsmStatement: &cc.AsmStatement{
	// · · Asm: &cc.Asm{
...
func ExampleStorageClassSpecifier_typedef() {
	fmt.Println(exampleAST(91, "typedef int int_t;"))
	// Output:
...
func ExampleStorageClassSpecifier_extern() {
	fmt.Println(exampleAST(92, "extern int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStorageClassSpecifier_static() {
	fmt.Println(exampleAST(93, "static int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: StorageClassSpecifierStatic,
...
func ExampleStorageClassSpecifier_auto() {
	fmt.Println(exampleAST(94, "auto int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStorageClassSpecifier_register() {
	fmt.Println(exampleAST(95, "register int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: StorageClassSpecifierRegister,
	// · Token: example.c:1:1: REGISTER "register",
...
func ExampleStorageClassSpecifier_threadLocal() {
	fmt.Println(exampleAST(96, "_Thread_local int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStructDeclaration_case0() {
	fmt.Println(exampleAST(128, "struct{ int i __attribute__((a)); };"))
	// Output:
...
func ExampleStructDeclarationList_case0() {
	fmt.Println(exampleAST(126, "struct{ __attribute__((a)) int i; };"))
	// Output:
...
func ExampleStructDeclarationList_case1() {
	fmt.Println(exampleAST(127, "struct{ int i; double d; };"))
	// Output:
	// &cc.StructDeclarationList{
	// · StructDeclaration: &cc.StructDeclaration{
	// · · SpecifierQualifierList: &cc.SpecifierQualifierList{
...
func ExampleStructDeclarator_bitField() {
	fmt.Println(exampleAST(134, "struct{ int i:3; };"))
	// Output:
	// &cc.StructDeclarator{
...
func ExampleStructDeclaratorList_case0() {
	fmt.Println(exampleAST(131, "struct{ int i; };"))
	// Output:
...
func ExampleStructDeclaratorList_case1() {
	fmt.Println(exampleAST(132, "struct{ int i, j; };"))
	// Output:
	// &cc.StructDeclaratorList{
	// · StructDeclarator: &cc.StructDeclarator{
	// · · Case: StructDeclaratorDecl,
...
func ExampleStructOrUnion_struct() {
	fmt.Println(exampleAST(124, "struct { int i; } s;"))
	// Output:
	// &cc.StructOrUnion{
...
func ExampleStructOrUnion_union() {
	fmt.Println(exampleAST(125, "union { int i; double d; } u;"))
	// Output:
	// &cc.StructOrUnion{
...
func ExampleStructOrUnionSpecifier_def() {
	fmt.Println(exampleAST(122, "struct s { int i; } __attribute__((a));"))
	// Output:
...
func ExampleStructOrUnionSpecifier_tag() {
	fmt.Println(exampleAST(123, "struct __attribute__((a)) s v;"))
	// Output:
	// &cc.StructOrUnionSpecifier{
	// · AttributeSpecifierList: &cc.AttributeSpecifierList{
	// · · AttributeSpecifier: &cc.AttributeSpecifier{
...
func ExampleTranslationUnit_case0() {
	fmt.Println(exampleAST(217, "int i;"))
	// Output:
	// &cc.TranslationUnit{
...
func ExampleTranslationUnit_case1() {
	fmt.Println(exampleAST(218, "int i; int j;"))
	// Output:
	// &cc.TranslationUnit{
	// · ExternalDeclaration: &cc.ExternalDeclaration{
	// · · Case: ExternalDeclarationDecl,
...
func ExampleTypeName_case0() {
	fmt.Println(exampleAST(170, "int i = (int)x;"))
	// Output:
	// &cc.TypeName{
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
	// · · Case: SpecifierQualifierListTypeSpec,
...
func ExampleTypeQualifier_const() {
	fmt.Println(exampleAST(142, "const int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierConst,
...
func ExampleTypeQualifier_restrict() {
	fmt.Println(exampleAST(143, "restrict int i;"))
	// Output:
	// &cc.TypeQualifier{
...
func ExampleTypeQualifier_volatile() {
	fmt.Println(exampleAST(144, "volatile int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierVolatile,
	// · Token: example.c:1:1: VOLATILE "volatile",
...
func ExampleTypeQualifier_atomic() {
	fmt.Println(exampleAST(145, "_Atomic int i;"))
	// Output:
	// &cc.TypeQualifier{
...
func ExampleTypeQualifiers_typeQual() {
	fmt.Println(exampleAST(160, "int * __attribute__((a)) const i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeQualifiers_case1() {
	fmt.Println(exampleAST(161, "int * const volatile i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeSpecifier_void() {
	fmt.Println(exampleAST(97, "void i();"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_char() {
	fmt.Println(exampleAST(98, "char i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierChar,
...
func ExampleTypeSpecifier_short() {
	fmt.Println(exampleAST(99, "short i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_int() {
	fmt.Println(exampleAST(100, "int i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:1: INT "int",
...
func ExampleTypeSpecifier_int128() {
	fmt.Println(exampleAST(101, "__int128 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_uint128() {
	fmt.Println(exampleAST(102, "__uint128_t i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_long() {
	fmt.Println(exampleAST(103, "long i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float() {
	fmt.Println(exampleAST(104, "float i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float16() {
	fmt.Println(exampleAST(105, "_Float16 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float128() {
	fmt.Println(exampleAST(106, "_Float128 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float128x() {
	fmt.Println(exampleAST(107, "_Float128x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_double() {
	fmt.Println(exampleAST(108, "double i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierDouble,
...
func ExampleTypeSpecifier_signed() {
	fmt.Println(exampleAST(109, "signed i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_unsigned() {
	fmt.Println(exampleAST(110, "unsigned i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_bool() {
	fmt.Println(exampleAST(111, "_Bool i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_complex() {
	fmt.Println(exampleAST(112, "_Complex i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_imaginary() {
	fmt.Println(exampleAST(113, "_Imaginary i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_structOrUnion() {
	fmt.Println(exampleAST(114, "struct s i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_enum() {
	fmt.Println(exampleAST(115, "enum e i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_typeName() {
	fmt.Println(exampleAST(116, "typedef int T; T i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:9: INT "int",
...
func ExampleTypeSpecifier_atomic() {
	fmt.Println(exampleAST(117, "_Atomic(int) i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float32() {
	fmt.Println(exampleAST(118, "_Float32 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float64() {
	fmt.Println(exampleAST(119, "_Float64 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float32x() {
	fmt.Println(exampleAST(120, "_Float32x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float64x() {
	fmt.Println(exampleAST(121, "_Float64x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleUnaryExpression_labelAddr() {
	fmt.Println(exampleAST(32, "int f() { L: &&L; }"))
	// Output:
	// &cc.UnaryExpression{
...
func ExampleUnaryExpression_alignofExpr() {
	fmt.Println(exampleAST(33, "int i = _Alignof(x);"))
	// Output:
	// &cc.UnaryExpression{
...
func ExampleUnaryExpression_alignofType() {
	fmt.Println(exampleAST(34, "int i = _Alignof(int);"))
	// Output:
	// &cc.UnaryExpression{
