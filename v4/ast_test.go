...
func ExampleAlignmentSpecifier_type() {
	fmt.Println(exampleAST(166, "_Alignas(double) char c;"))
	// Output:
...
func ExampleAlignmentSpecifier_expr() {
	fmt.Println(exampleAST(167, "_Alignas(0ll) char c;"))
	// Output:
	// &cc.AlignmentSpecifier{
...
func ExampleAsm_case0() {
	fmt.Println(exampleAST(255, "asm(\"nop\");"))
	// Output:
	// &cc.Asm{
...
func ExampleAsmArgList_case0() {
	fmt.Println(exampleAST(253, "asm(\"nop\": a);"))
	// Output:
	// &cc.AsmArgList{
...
func ExampleAsmQualifier_volatile() {
	fmt.Println(exampleAST(257, "asm volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifier_goto() {
	fmt.Println(exampleAST(259, "asm goto (\"nop\");"))
	// Output:
	// &cc.AsmQualifier{
...
func ExampleAsmQualifierList_case0() {
	fmt.Println(exampleAST(260, "asm inline (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
...
func ExampleAsmQualifierList_case1() {
	fmt.Println(exampleAST(261, "asm inline volatile (\"nop\");"))
	// Output:
	// &cc.AsmQualifierList{
	// · AsmQualifier: &cc.AsmQualifier{
	// · · Case: AsmQualifierInline,
...
func ExampleAsmStatement_case0() {
	fmt.Println(exampleAST(256, "void f() { asm(\"nop\"); }"))
	// Output:
	// &cc.AsmStatement{
	// · Asm: &cc.Asm{
...
func ExampleAtomicTypeSpecifier_case0() {
	fmt.Println(exampleAST(156, "_Atomic(int) i;"))
	// Output:
...
func ExampleAttributeSpecifierList_case1() {
	fmt.Println(exampleAST(269, "int i __attribute__((a)) __attribute__((b));"))
	// Output:
	// &cc.AttributeSpecifierList{
	// · AttributeSpecifier: &cc.AttributeSpecifier{
	// · · AttributeValueList: &cc.AttributeValueList{
...
func ExampleAttributeValueList_case1() {
	fmt.Println(exampleAST(266, "int i __attribute__((a, b));"))
	// Output:
	// &cc.AttributeValueList{
	// · AttributeValue: &cc.AttributeValue{
	// · · Case: AttributeValueIdent,
...
func ExampleCompoundStatement_case0() {
	fmt.Println(exampleAST(220, "int f() { __label__ L; int i; }"))
	// Output:
...
func ExampleDeclarationSpecifiers_attr() {
	fmt.Println(exampleAST(96, "__attribute__((a)) int i;"))
	// Output:
	// &cc.DeclarationSpecifiers{
	// · AttributeSpecifierList: &cc.AttributeSpecifierList{
	// · · AttributeSpecifier: &cc.AttributeSpecifier{
...
func ExampleDesignator_index2() {
	fmt.Println(exampleAST(206, "int a[] = { [42 ... 278] = 314 };"))
	// Output:
	// &cc.Designator{
...
func ExampleDesignator_field() {
	fmt.Println(exampleAST(207, "struct t s = { .fld = 314 };"))
	// Output:
	// &cc.Designator{
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(204, "int a[100][] = { [42][12] = 314 };"))
	// Output:
	// &cc.DesignatorList{
	// · Designator: &cc.Designator{
	// · · Case: DesignatorIndex,
...
func ExampleDirectAbstractDeclarator_arr() {
	fmt.Println(exampleAST(193, "void f(int[const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_staticArr() {
	fmt.Println(exampleAST(194, "void f(int[static const 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_arrStatic() {
	fmt.Println(exampleAST(195, "void f(int[const static 42]);"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectAbstractDeclarator_func() {
	fmt.Println(exampleAST(197, "void f(int(char));"))
	// Output:
	// &cc.DirectAbstractDeclarator{
	// · Case: DirectAbstractDeclaratorFunc,
...
func ExampleDirectDeclarator_ident() {
	fmt.Println(exampleAST(168, "int i;"))
	// Output:
	// &cc.DirectDeclarator{
	// · Case: DirectDeclaratorIdent,
	// · Token: example.c:1:5: IDENTIFIER "i",
...
func ExampleDirectDeclarator_decl() {
	fmt.Println(exampleAST(169, "int (f);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_arr() {
	fmt.Println(exampleAST(170, "int i[const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_staticArr() {
	fmt.Println(exampleAST(171, "int i[static const 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_arrStatic() {
	fmt.Println(exampleAST(172, "int i[const static 42];"))
	// Output:
	// &cc.DirectDeclarator{
	// · AssignmentExpression: &cc.AssignmentExpression{
	// · · Case: AssignmentExpressionCond,
...
func ExampleDirectDeclarator_star() {
	fmt.Println(exampleAST(173, "int i[const *];"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleDirectDeclarator_funcIdent() {
	fmt.Println(exampleAST(175, "int f(a);"))
	// Output:
	// &cc.DirectDeclarator{
...
func ExampleEnumSpecifier_tag() {
	fmt.Println(exampleAST(151, "enum e i;"))
	// Output:
	// &cc.EnumSpecifier{
...
func ExampleEnumerator_expr() {
	fmt.Println(exampleAST(155, "enum e {a = 42};"))
	// Output:
	// &cc.Enumerator{
	// · Case: EnumeratorExpr,
	// · ConstantExpression: &cc.ConstantExpression{
...
func ExampleEnumeratorList_case1() {
	fmt.Println(exampleAST(153, "enum e {a, b};"))
	// Output:
	// &cc.EnumeratorList{
	// · Enumerator: &cc.Enumerator{
	// · · Case: EnumeratorIdent,
...
func ExampleExpressionStatement_case0() {
	fmt.Println(exampleAST(228, "int f() { g(); }"))
	// Output:
...
func ExampleExternalDeclaration_funcDef() {
	fmt.Println(exampleAST(243, "int f() {}"))
	// Output:
...
func ExampleExternalDeclaration_decl() {
	fmt.Println(exampleAST(244, "register int i asm(\"r0\");"))
	// Output:
	// &cc.ExternalDeclaration{
...
func ExampleFunctionSpecifier_inline() {
	fmt.Println(exampleAST(163, "inline int f() {}"))
	// Output:
...
func ExampleFunctionSpecifier_noreturn() {
	fmt.Println(exampleAST(164, "_Noreturn int f() {}"))
	// Output:
	// &cc.FunctionSpecifier{
...
func ExampleIdentifierList_case0() {
	fmt.Println(exampleAST(187, "int f(i) int i; {}"))
	// Output:
	// &cc.IdentifierList{
...
func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(188, "int f(i, j) int i, j; {}"))
	// Output:
	// &cc.IdentifierList{
	// · IdentifierList: &cc.IdentifierList{
	// · · Token: example.c:1:8: ',' ",",
...
func ExampleInitDeclarator_decl() {
	fmt.Println(exampleAST(99, "register int i asm(\"r0\");"))
	// Output:
	// &cc.InitDeclarator{
	// · Asm: &cc.Asm{
	// · · Token: example.c:1:16: ASM "asm",
...
func ExampleInitDeclarator_init() {
	fmt.Println(exampleAST(100, "register int i asm(\"r0\") = x;"))
	// Output:
	// &cc.InitDeclarator{
	// · Asm: &cc.Asm{
	// · · Token: example.c:1:16: ASM "asm",
...
func ExampleInitDeclaratorList_case1() {
	fmt.Println(exampleAST(98, "int i, __attribute__((a)) j;"))
	// Output:
	// &cc.InitDeclaratorList{
	// · InitDeclarator: &cc.InitDeclarator{
	// · · Case: InitDeclaratorDecl,
...
func ExampleInitializer_initList() {
	fmt.Println(exampleAST(199, "int i[] = { x };"))
	// Output:
	// &cc.Initializer{
	// · Case: InitializerExpr,
...
func ExampleInitializerList_case0() {
	fmt.Println(exampleAST(200, "int i[] = { [10] = x };"))
	// Output:
	// &cc.InitializerList{
...
func ExampleInitializerList_case1() {
	fmt.Println(exampleAST(201, "int i[] = { [10] = x, [20] = y };"))
	// Output:
	// &cc.InitializerList{
	// · Designation: &cc.Designation{
	// · · DesignatorList: &cc.DesignatorList{
...
func ExampleIterationStatement_while() {
	fmt.Println(exampleAST(232, "int f() { while(x) y(); }"))
	// Output:
...
func ExampleIterationStatement_do() {
	fmt.Println(exampleAST(233, "int f() { do x(); while(y); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleIterationStatement_for() {
	fmt.Println(exampleAST(234, "int f() { for( i = 0; i < 10; i++) x(); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleIterationStatement_forDecl() {
	fmt.Println(exampleAST(235, "int f() { for( int i = 0; i < 10; i++) x(); }"))
	// Output:
	// &cc.IterationStatement{
...
func ExampleJumpStatement_goto() {
	fmt.Println(exampleAST(236, "int f() { L: goto L; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_gotoExpr() {
	fmt.Println(exampleAST(237, "int f() { L: x(); void *p = &&L; goto *p; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_continue() {
	fmt.Println(exampleAST(238, "int f() { for(;;) if (i) continue; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_break() {
	fmt.Println(exampleAST(239, "int f() { for(;;) if (i) break; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleJumpStatement_return() {
	fmt.Println(exampleAST(240, "int f() { if (i) return x; }"))
	// Output:
	// &cc.JumpStatement{
...
func ExampleLabelDeclaration_case0() {
	fmt.Println(exampleAST(262, "int f() { __label__ L, M; L: x(); M: y(); }"))
	// Output:
	// &cc.LabelDeclaration{
	// · IdentifierList: &cc.IdentifierList{
	// · · IdentifierList: &cc.IdentifierList{
...
func ExampleLabelDeclarationList_case0() {
	fmt.Println(exampleAST(221, "int f() { __label__ L; int i; }"))
	// Output:
...
func ExampleLabelDeclarationList_case1() {
	fmt.Println(exampleAST(222, "int f() { __label__ L; __label__ L2; int i; }"))
	// Output:
	// &cc.LabelDeclarationList{
	// · LabelDeclaration: &cc.LabelDeclaration{
	// · · IdentifierList: &cc.IdentifierList{
...
func ExampleLabeledStatement_label() {
	fmt.Println(exampleAST(216, "int f() { L: goto L; }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleLabeledStatement_caseLabel() {
	fmt.Println(exampleAST(217, "int f() { switch(i) case 42: x(); }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleLabeledStatement_range() {
	fmt.Println(exampleAST(218, "int f() { switch(i) case 42 ... 56: x(); }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleLabeledStatement_default() {
	fmt.Println(exampleAST(219, "int f() { switch(i) default: x(); }"))
	// Output:
	// &cc.LabeledStatement{
...
func ExampleParameterDeclaration_decl() {
	fmt.Println(exampleAST(185, "int f(int i __attribute__((a))) {}"))
	// Output:
...
func ExampleParameterDeclaration_abstract() {
	fmt.Println(exampleAST(186, "int f(int*) {}"))
	// Output:
	// &cc.ParameterDeclaration{
	// · AbstractDeclarator: &cc.AbstractDeclarator{
	// · · Case: AbstractDeclaratorPtr,
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(184, "int f(int i, int j) {}"))
	// Output:
	// &cc.ParameterList{
	// · ParameterDeclaration: &cc.ParameterDeclaration{
	// · · Case: ParameterDeclarationDecl,
...
func ExamplePointer_block() {
	fmt.Println(exampleAST(178, "int atexit_b(void (^ _Nonnull)(void));"))
	// Output:
	// &cc.Pointer{
	// · Case: PointerBlock,
...
func ExampleSelectionStatement_if() {
	fmt.Println(exampleAST(229, "int f() { if(x) y(); }"))
	// Output:
...
func ExampleSelectionStatement_ifElse() {
	fmt.Println(exampleAST(230, "int f() { if(x) y(); else z(); }"))
	// Output:
	// &cc.SelectionStatement{
...
func ExampleSelectionStatement_switch() {
	fmt.Println(exampleAST(231, "int f() { switch(i) case 42: x(); }"))
	// Output:
	// &cc.SelectionStatement{
...
func ExampleSpecifierQualifierList_typeQual() {
	fmt.Println(exampleAST(144, "struct {const int i;};"))
	// Output:
	// &cc.SpecifierQualifierList{
	// · Case: SpecifierQualifierListTypeQual,
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
...
func ExampleSpecifierQualifierList_alignSpec() {
	fmt.Println(exampleAST(145, "struct {_Alignas(double) int i;};"))
	// Output:
	// &cc.SpecifierQualifierList{
	// · AlignmentSpecifier: &cc.AlignmentSpecifier{
	// · · Case: AlignmentSpecifierType,
...
func ExampleStatement_labeled() {
	fmt.Println(exampleAST(209, "int f() { L: x(); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementLabeled,
	// · LabeledStatement: &cc.LabeledStatement{
...
func ExampleStatement_compound() {
	fmt.Println(exampleAST(210, "int f() { { y(); } }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_expr() {
	fmt.Println(exampleAST(211, "int f() { __attribute__((a)); }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementExpr,
	// · ExpressionStatement: &cc.ExpressionStatement{
...
func ExampleStatement_selection() {
	fmt.Println(exampleAST(212, "int f() { if(x) y(); }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_iteration() {
	fmt.Println(exampleAST(213, "int f() { for(;;) x(); }"))
	// Output:
	// &cc.Statement{
...
func ExampleStatement_jump() {
	fmt.Println(exampleAST(214, "int f() { return x; }"))
	// Output:
	// &cc.Statement{
	// · Case: StatementJump,
	// · JumpStatement: &cc.JumpStatement{
...
func ExampleStatement_asm() {
	fmt.Println(exampleAST(215, "int f() { asm(\"nop\"); }"))
	// Output:
	// &cc.Statement{
	// · AsmStatement: &cc.AsmStatement{
	// · · Asm: &cc.Asm{
...
func ExampleStorageClassSpecifier_typedef() {
	fmt.Println(exampleAST(101, "typedef int int_t;"))
	// Output:
...
func ExampleStorageClassSpecifier_extern() {
	fmt.Println(exampleAST(102, "extern int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStorageClassSpecifier_static() {
	fmt.Println(exampleAST(103, "static int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: StorageClassSpecifierStatic,
...
func ExampleStorageClassSpecifier_auto() {
	fmt.Println(exampleAST(104, "auto int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStorageClassSpecifier_register() {
	fmt.Println(exampleAST(105, "register int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
	// · Case: StorageClassSpecifierRegister,
	// · Token: example.c:1:1: REGISTER "register",
...
func ExampleStorageClassSpecifier_threadLocal() {
	fmt.Println(exampleAST(106, "_Thread_local int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStorageClassSpecifier_declspec() {
	fmt.Println(exampleAST(107, "__declspec(foo) int i;"))
	// Output:
	// &cc.StorageClassSpecifier{
...
func ExampleStructDeclaration_case0() {
	fmt.Println(exampleAST(142, "struct{ int i __attribute__((a)); };"))
	// Output:
...
func ExampleStructDeclarationList_case0() {
	fmt.Println(exampleAST(140, "struct{ __attribute__((a)) int i; };"))
	// Output:
...
func ExampleStructDeclarationList_case1() {
	fmt.Println(exampleAST(141, "struct{ int i; double d; };"))
	// Output:
	// &cc.StructDeclarationList{
	// · StructDeclaration: &cc.StructDeclaration{
	// · · SpecifierQualifierList: &cc.SpecifierQualifierList{
...
func ExampleStructDeclarator_bitField() {
	fmt.Println(exampleAST(149, "struct{ int i:3; };"))
	// Output:
	// &cc.StructDeclarator{
...
func ExampleStructDeclaratorList_case1() {
	fmt.Println(exampleAST(147, "struct{ int i, j; };"))
	// Output:
	// &cc.StructDeclaratorList{
	// · StructDeclarator: &cc.StructDeclarator{
	// · · Case: StructDeclaratorDecl,
...
func ExampleStructOrUnion_struct() {
	fmt.Println(exampleAST(138, "struct { int i; } s;"))
	// Output:
	// &cc.StructOrUnion{
...
func ExampleStructOrUnion_union() {
	fmt.Println(exampleAST(139, "union { int i; double d; } u;"))
	// Output:
	// &cc.StructOrUnion{
...
func ExampleStructOrUnionSpecifier_def() {
	fmt.Println(exampleAST(136, "struct s { int i; } __attribute__((a));"))
	// Output:
...
func ExampleStructOrUnionSpecifier_tag() {
	fmt.Println(exampleAST(137, "struct __attribute__((a)) s v;"))
	// Output:
	// &cc.StructOrUnionSpecifier{
	// · AttributeSpecifierList: &cc.AttributeSpecifierList{
	// · · AttributeSpecifier: &cc.AttributeSpecifier{
...
func ExampleTranslationUnit_case0() {
	fmt.Println(exampleAST(241, "int i;"))
	// Output:
	// &cc.TranslationUnit{
...
func ExampleTranslationUnit_case1() {
	fmt.Println(exampleAST(242, "int i; int j;"))
	// Output:
	// &cc.TranslationUnit{
	// · ExternalDeclaration: &cc.ExternalDeclaration{
	// · · Case: ExternalDeclarationDecl,
...
func ExampleTypeName_case0() {
	fmt.Println(exampleAST(189, "int i = (int)x;"))
	// Output:
	// &cc.TypeName{
	// · SpecifierQualifierList: &cc.SpecifierQualifierList{
	// · · Case: SpecifierQualifierListTypeSpec,
...
func ExampleTypeQualifier_const() {
	fmt.Println(exampleAST(157, "const int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierConst,
...
func ExampleTypeQualifier_restrict() {
	fmt.Println(exampleAST(158, "restrict int i;"))
	// Output:
	// &cc.TypeQualifier{
...
func ExampleTypeQualifier_volatile() {
	fmt.Println(exampleAST(159, "volatile int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierVolatile,
	// · Token: example.c:1:1: VOLATILE "volatile",
...
func ExampleTypeQualifier_nonnull() {
	fmt.Println(exampleAST(161, "_Nonnull int i;"))
	// Output:
	// &cc.TypeQualifier{
	// · Case: TypeQualifierNonnull,
...
func ExampleTypeQualifier_attr() {
	fmt.Println(exampleAST(162, "struct { __attribute__((a)) int i; };"))
	// Output:
	// &cc.TypeQualifier{
	// · AttributeSpecifierList: &cc.AttributeSpecifierList{
	// · · AttributeSpecifier: &cc.AttributeSpecifier{
...
func ExampleTypeQualifiers_typeQual() {
	fmt.Println(exampleAST(179, "int * __attribute__((a)) const i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeQualifiers_case1() {
	fmt.Println(exampleAST(180, "int * const volatile i;"))
	// Output:
	// &cc.TypeQualifiers{
	// · Case: TypeQualifiersTypeQual,
	// · TypeQualifier: &cc.TypeQualifier{
...
func ExampleTypeSpecifier_void() {
	fmt.Println(exampleAST(108, "void i();"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_char() {
	fmt.Println(exampleAST(109, "char i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierChar,
...
func ExampleTypeSpecifier_short() {
	fmt.Println(exampleAST(110, "short i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_int() {
	fmt.Println(exampleAST(111, "int i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:1: INT "int",
...
func ExampleTypeSpecifier_int128() {
	fmt.Println(exampleAST(112, "__int128 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_uint128() {
	fmt.Println(exampleAST(113, "__uint128_t i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_long() {
	fmt.Println(exampleAST(114, "long i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float() {
	fmt.Println(exampleAST(115, "float i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierFloat,
...
func ExampleTypeSpecifier_float16() {
	fmt.Println(exampleAST(116, "_Float16 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_decimal64() {
	fmt.Println(exampleAST(117, "_Decimal64 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float128x() {
	fmt.Println(exampleAST(119, "_Float128x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_imaginary() {
	fmt.Println(exampleAST(125, "_Imaginary i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_structOrUnion() {
	fmt.Println(exampleAST(126, "struct s i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_enum() {
	fmt.Println(exampleAST(127, "enum e i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_typeName() {
	fmt.Println(exampleAST(128, "typedef int T; T i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:9: INT "int",
...
func ExampleTypeSpecifier_typeofExpr() {
	fmt.Println(exampleAST(129, "typeof(42) i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_typeofType() {
	fmt.Println(exampleAST(130, "typedef int T; typeof(T) i;"))
	// Output:
	// &cc.TypeSpecifier{
	// · Case: TypeSpecifierInt,
	// · Token: example.c:1:9: INT "int",
...
func ExampleTypeSpecifier_atomic() {
	fmt.Println(exampleAST(131, "_Atomic(int) i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float32() {
	fmt.Println(exampleAST(132, "_Float32 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float64() {
	fmt.Println(exampleAST(133, "_Float64 i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float32x() {
	fmt.Println(exampleAST(134, "_Float32x i;"))
	// Output:
	// &cc.TypeSpecifier{
...
func ExampleTypeSpecifier_float64x() {
	fmt.Println(exampleAST(135, "_Float64x i;"))
	// Output:
	// &cc.TypeSpecifier{
